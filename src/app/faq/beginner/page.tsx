...
export const metadata: Metadata = {
  ...
  description:
    "釣り初心者が知りたい道具の揃え方、予算の目安（3,000円〜）、おすすめの釣り場の選び方、サビキ釣りのやり方、エサの種類と使い分けなど基本的な疑問にわかりやすく回答。釣りデビュー前に読んでおきたい入門ガイドです。",
  openGraph: {
    title: "釣り初心者FAQ - 必要な道具・予算・場所選び・始め方",
    description:
      "釣り初心者が知りたい基本的な疑問にわかりやすく回答。道具の揃え方、予算の目安、おすすめの釣り場選びまで網羅した入門ガイド。",
    type: "website",
