...
export const metadata: Metadata = {
  title: "ジェット天秤の重さ（号数）の選び方と使い方｜初心者向け完全ガイド",
  description:
    "ジェット天秤の重さ（号数）の選び方と使い方を初心者向けに完全解説。8号・10号・15号・20号の使い分け、なぜ遠投できるのか、根がかりしにくい理由、投げ釣り・ちょい投げ・泳がせ釣りでの仕掛けの作り方まで。実釣レポートつき。",
  openGraph: {
    title: "ジェット天秤の重さ（号数）の選び方と使い方｜初心者向けガイド",
    description:
...
const guideSpeakableJsonLd = {
  ...
  "@type": "WebPage",
  name: "ジェット天秤の使い方｜初心者でも遠投できる最強アイテム",
  url: "https://tsurispot.com/guide/jet-sinker",
  speakable: {
