...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "ツリスポ",
    images: [{
      url: `/api/og?title=${encodeURIComponent("夜釣り入門ガイド")}&emoji=${encodeURIComponent("🌙")}`,
      width: 1200,
      height: 630,
    }],
  },
...
const guideSpeakableJsonLd = {
  ...
  "@type": "WebPage",
  name: "夜釣り入門ガイド - 必要装備・釣れる魚・安全対策を解説",
  url: "https://tsurispot.com/guide/night-fishing",
  speakable: {
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h2 className="text-xl font-bold">夜釣りにおすすめのスポット</h2>
                </div>
                <p className="mb-4 text-sm text-muted-foreground">
                  常夜灯があり、足場の良い堤防や漁港が夜釣りには最適です。
                </p>
