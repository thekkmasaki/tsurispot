    ...
    items: [
      ...
      },
      {
        ...
        affiliate: {
          ...
          name: "シマノ スピニングリール",
          desc: "滑らかな巻き心地で初心者にも扱いやすい。2000〜3000番がサビキ・ちょい投げに万能。",
      ...
      },
      {
        ...
        affiliate: {
          ...
          name: "おもりセット（各サイズ入り）",
          desc: "号数別に揃ったセット。釣り方に合わせてすぐに選べて便利。忘れがちなアイテムNo.1。",
      ...
      },
      {
        ...
        affiliate: {
          ...
          name: "東レ ナイロンライン",
          desc: "視認性が高く扱いやすいナイロンライン。サビキ・ウキ釣り・ちょい投げの道糸に最適。",
      ...
      },
      {
        ...
        affiliate: {
          ...
          name: "マルキュー アミ姫",
          desc: "チューブタイプで手が汚れにくいコマセ。フルーティーな香りでにおいも少なく、サビキ釣りの必須アイテム。",
    ...
    items: [
      ...
      { id: "rainwear", label: "レインウェア", note: "急な雨や波しぶき対策に" },
      {
        ...
        affiliate: {
          ...
          name: "防寒フィッシンググローブ",
          desc: "指先が出せるタイプで仕掛けの操作もしやすい。冬の釣りには必須の防寒手袋。",
      ...
      { id: "bugspray", label: "虫除けスプレー", note: "夏場は特に必須" },
      {
        ...
        affiliate: {
          ...
          desc: "大容量で1日安心。電熱ベストの給電やスマホ充電に。釣り場での長時間使用も安心。",
