...
export const metadata: Metadata = {
  ...
  description:
    "サビキ釣り・アジング・エギング・ショアジギング・タチウオ釣り・ちょい投げ・ウキ釣り・穴釣りなど、人気の釣法9種類を初心者向けにわかりやすく解説。必要なタックル・仕掛け、釣り方の手順、上達のコツまで網羅。自分に合った釣り方を見つけよう。",
  openGraph: {
    title: "釣り方・釣法ガイド - 9つの釣法を徹底解説",
    description:
      "サビキ・アジング・エギングなど人気の釣法9種類を初心者向けに徹底解説。必要なタックル・手順・コツまで網羅。",
    type: "website",
