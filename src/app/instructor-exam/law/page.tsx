...
/* ============================================================
   コールアウト コンポーネント（Tailwind CSSで再現）
   ============================================================ */
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <Quiz
          ...
          answer="3. 素潜りで採ったアワビ"
          explanation="アワビは共同漁業権の対象となる定着性の水産動物です。竿釣りで釣ったアジ・キス・スズキは一般的に漁業権侵害に該当しません。"
        />
        ...
        <Quiz
          ...
          answer="2. サビキ釣り"
          explanation="サビキ釣りは一般的な遊漁の方法であり、禁止されていません。ただし、一部の港湾では撒き餌（コマセ）が禁止されている場所もあるため注意が必要です。"
        />
        ...
        <Quiz
          ...
          answer="3. 遊漁船業者は業務主任者を選任しなければならない"
          explanation="遊漁船業は都道府県知事への「登録」制であり、「許可」ではありません。有効期間は5年です。業務主任者の選任は法定義務です。損害賠償措置を講じる義務もあります。"
        />
        ...
        <Quiz
          ...
          answer="2. 河川での採捕は原則として禁止されている"
          explanation="さけは水産資源保護法に基づき、河川での採捕が原則禁止されています。ふ化放流事業の保護が目的です。海ではサケ釣りが可能な地域もあり、北海道の一部河川では知事許可による釣りが認められています。"
        />
        ...
        <Quiz
          ...
          answer="4. 3年以下の懲役又は3,000万円以下の罰金"
          explanation="2020年改正で新設された漁業法第132条により、特定水産動植物（アワビ・ナマコ・シラスウナギ等）の無権限採捕は3年以下の懲役又は3,000万円以下の罰金と、非常に重い罰則が設けられました。"
        />
        ...
        <Quiz
          question="Q1. 現行漁業法（2020年改正）の第一の目的として正しいものはどれか？"
          options={[
            "漁業者の所得向上",
            "水産資源の持続的な利用の確保",
            "水面の私的利用の促進",
          ...
          answer="2. 水産資源の持続的な利用の確保"
          explanation="2020年改正で漁業法の目的に「水産資源の持続的な利用を確保する」ことが明記されました。旧法の「漁業の民主化」から大きく転換した点です。"
        />

        <Quiz
          question="Q2. 漁業権の種類に含まれないものはどれか？"
          options={[
            "共同漁業権",
            "区画漁業権",
            "定置漁業権",
          ...
          answer="4. 遊漁権"
          explanation="漁業権は共同漁業権・区画漁業権・定置漁業権の3種類です。「遊漁権」という権利は存在しません。"
        />

        <Quiz
          question="Q3. 共同漁業権が設定された水域で、遊漁者が行うと漁業権侵害になるのはどれか？"
          options={[
            "堤防からのサビキ釣り",
            "ルアーでのシーバス釣り",
            "サザエの素潜り採捕",
          ...
          answer="3. サザエの素潜り採捕"
          explanation="サザエは共同漁業権の対象となる定着性の水産動物です。竿釣りやルアーで魚を釣ることは一般的に漁業権侵害にはなりません。"
        />

        <Quiz
          question="Q4. 体長制限で小型魚の採捕が禁止される根拠法令は何か？"
          options={[
            "漁業法",
            "水産資源保護法",
            "都道府県漁業調整規則",
          ...
          answer="3. 都道府県漁業調整規則"
          explanation="体長制限（小型魚の再放流義務）は各都道府県の漁業調整規則で定められています。規制内容は都道府県によって異なります。"
        />

        <Quiz
          question="Q5. 遊漁者が一般的に使用を禁止されている漁法はどれか？"
          options={[
            "サビキ釣り",
            "投げ釣り",
            "電気を使った魚の採捕",
          ...
          answer="3. 電気を使った魚の採捕"
          explanation="電気・薬品による水産動植物の採捕は全面的に禁止されています。サビキ、投げ、ウキは一般的な遊漁の方法として認められています。"
        />

        <Quiz
          question="Q6. 遊漁船業を営むための手続きとして正しいものはどれか？"
          options={[
            "農林水産大臣の許可",
            "都道府県知事への届出",
            "都道府県知事への登録",
          ...
          answer="3. 都道府県知事への登録"
          explanation="遊漁船業法第3条により、遊漁船業を営もうとする者は都道府県知事の「登録」を受けなければなりません。「届出」ではなく「登録」、「許可」でもなく「登録」です。"
        />

        <Quiz
          question="Q7. 遊漁船業の登録の有効期間は何年か？"
          options={["1年", "3年", "5年", "10年"]}
          answer="3. 5年"
          explanation="遊漁船業法第4条により、登録の有効期間は5年です。更新を受けなければ期間経過によりその効力を失います。"
        />

        <Quiz
          question="Q8. 遊漁船業者が選任しなければならない者は何か？"
          options={[
            "安全管理者",
            "業務主任者",
            "航海士",
          ...
          answer="2. 業務主任者"
          explanation="遊漁船業法第12条により、遊漁船業者は業務主任者を選任しなければなりません。業務主任者は所定の講習を修了した者である必要があります。"
        />

        <Quiz
          question="Q9. 水産資源保護法に基づき、河川での採捕が原則禁止されている魚はどれか？"
          options={[
            "ニジマス",
            "アユ",
            "シロザケ（さけ）",
          ...
          answer="3. シロザケ（さけ）"
          explanation="さけ（シロザケ）は水産資源保護法に基づき河川での採捕が原則禁止されています。ふ化放流事業の保護が目的です。アユやイワナの規制は各都道府県の漁業調整規則等で定められています。"
        />

        <Quiz
          question="Q10. 特定外来生物に指定されている魚として正しいものはどれか？"
          options={[
            "ニジマス",
            "ブラウントラウト",
            "オオクチバス（ブラックバス）",
          ...
          answer="3. オオクチバス（ブラックバス）"
          explanation="オオクチバスは外来生物法の特定外来生物に指定されています。ニジマスやブラウントラウトは特定外来生物には指定されていません（産業管理外来種）。ヘラブナは在来種です。"
        />

        <Quiz
          question="Q11. 外来生物法で禁止されている行為はどれか？"
          options={[
          ...
          answer="2. 特定外来生物を生きたまま別の水域に運搬すること"
          explanation="外来生物法では特定外来生物の飼養・運搬・放出が禁止されています。その場でのリリースは法律上禁止されていませんが、自治体の条例で禁止している場合があります。その場で締めて食用にすることは問題ありません。"
        />

        <Quiz
          question="Q12. 2020年改正漁業法で「特定水産動植物」として指定されたものに含まれないものはどれか？"
          options={[
            "アワビ",
            "ナマコ",
            "シラスウナギ",
          ...
          answer="4. マアジ"
          explanation="特定水産動植物にはアワビ・ナマコ・シラスウナギが指定されています。マアジは一般的な釣りの対象魚であり、特定水産動植物には指定されていません。"
        />

        <Quiz
          question="Q13. 特定水産動植物の密漁に対する罰則として正しいものはどれか？"
          options={[
            "10万円以下の過料",
            "50万円以下の罰金",
            "1年以下の懲役又は100万円以下の罰金",
          ...
          answer="4. 3年以下の懲役又は3,000万円以下の罰金"
          explanation="2020年改正漁業法により、特定水産動植物の密漁には最高で3年以下の懲役又は3,000万円以下の罰金という重い罰則が設けられました。"
        />

        <Quiz
          question="Q14. 保護水面を指定する権限を持つのは誰か？"
          options={[
            "市区町村長",
            "都道府県知事のみ",
            "農林水産大臣又は都道府県知事",
          ...
          answer="3. 農林水産大臣又は都道府県知事"
          explanation="水産資源保護法に基づき、保護水面は農林水産大臣又は都道府県知事が指定します。市区町村長や漁協組合長には指定権限はありません。"
        />

        <Quiz
          question="Q15. 漁業権について正しい記述はどれか？"
          options={[
            "漁業権は農林水産大臣が免許する",
            "遊漁者も申請すれば漁業権を取得できる",
            "漁業権は都道府県知事が漁協等に免許する",
          ...
          answer="3. 漁業権は都道府県知事が漁協等に免許する"
          explanation="漁業権は都道府県知事が漁業協同組合等に免許するものです。農林水産大臣ではありません。また、漁業権には有効期間があり、永久ではありません。遊漁者個人が漁業権を取得することはできません。"
        />
