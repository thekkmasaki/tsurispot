...
import { historyQuestions } from "@/lib/data/instructor-exam/history-questions";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    siteName: "ツリスポ",
    images: [{ url: "https://tsurispot.com/api/og?title=釣りの文化史 確認クイズ&emoji=📜", width: 1200, height: 630 }],
  },
  twitter: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "釣りの文化史", item: `${baseUrl}/instructor-exam/history` },
              { "@type": "ListItem", position: 4, name: "確認クイズ", item: `${baseUrl}/instructor-exam/history/quiz` },
            ],
          }),
        }}
      />
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <nav aria-label="パンくずリスト" className="mb-6 text-sm text-muted-foreground">
          <ol className="flex flex-wrap items-center gap-1.5">
            ...
            <li aria-hidden="true">/</li>
            <li><Link prefetch={false} href="/instructor-exam/history" className="hover:text-foreground">釣りの文化史</Link></li>
            <li aria-hidden="true">/</li>
        ...
        <ExamQuiz questions={historyQuestions} />
