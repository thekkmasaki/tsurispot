...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "釣りインストラクター試験 問題集・過去問対策【無料290問】",
    description:
      "公認釣りインストラクター試験の筆記対策をオンラインで無料学習。全7章・確認クイズ290問以上で合格をサポート。",
    url: `${baseUrl}/instructor-exam`,
    type: "website",
    siteName: "ツリスポ",
    images: [{ url: "https://tsurispot.com/api/og?title=釣りインストラクター試験対策【無料290問】&emoji=📝", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "釣りインストラクター試験 問題集・過去問対策【無料290問】",
    description:
      "漁業法・マナー・釣り具の知識を全7章・確認クイズ290問以上で無料学習。合格に必要な知識を網羅。",
    images: ["https://tsurispot.com/api/og?title=釣りインストラクター試験対策【無料290問】&emoji=📝"],
  },
  keywords: [
    "釣りインストラクター 試験",
    "釣りインストラクター 過去問",
