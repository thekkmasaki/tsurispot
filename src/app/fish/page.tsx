...
export const metadata: Metadata = {
  title: "魚種図鑑100種以上｜2026年最新の旬・釣り方・食べ方ガイド【初心者向け】",
  description:
    "100種以上の海水魚・淡水魚・汽水魚を図鑑形式で収録。2026年最新の旬カレンダー、初心者でもわかる釣り方・難易度・おすすめの食べ方を魚ごとに詳しく解説。アジ・サバ・カサゴ・シーバス・タチウオ・メバルなど人気ターゲットの仕掛けと旬がすぐ分かる。",
  openGraph: {
    title: "魚種図鑑100種以上｜2026年最新の旬・釣り方・食べ方ガイド",
    description:
      "100種以上の海水魚・淡水魚・汽水魚を図鑑形式で紹介。2026年最新の旬・難易度・おすすめ釣り方と食べ方まで網羅。",
    type: "website",
