...
export const metadata: Metadata = {
  ...
  description:
    "春 (メバル・カサゴ・アオリイカ)、 夏 (アジ・キス・シーバス)、 秋 (青物・タチウオ・イカ)、 冬 (ヒラメ・カレイ・ワカサギ) の代表ターゲット 20 種以上と季節別おすすめ釣法・装備・注意点を初心者向けに完全解説。 今の時期にベストな釣り方が一目でわかる。",
  openGraph: {
    title: "季節別釣りガイド - 春夏秋冬のおすすめ釣り",
    description:
      "春夏秋冬それぞれの季節で釣れる代表魚 20 種以上と、 おすすめ釣法・装備・注意点を初心者向けに完全解説します。",
    type: "article",
