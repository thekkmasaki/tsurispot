      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-50"
          >
          ...
          <button
            onClick={() =>
              signIn("cognito", { callbackUrl: "/" }, { identity_provider: "SignInWithApple" })
            }
            className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-black px-4 py-3 text-sm font-medium text-white transition-opacity hover:opacity-90"
          >
