...
import { SpotLeafletMapWrapper } from "@/components/map/spot-leaflet-map-wrapper";
        ...
        {analysisResult ? (
          <div className="mt-4">
            ...
            <p className="mb-3 text-sm text-muted-foreground">
              ゾーンをクリックすると、推定魚種・水深・潮通しなどの詳細が表示されます。
            </p>
            <style dangerouslySetInnerHTML={{ __html: `.analysis-map-wrap .leaflet-container { height: 450px !important; min-height: 450px !important; }` }} />
            <div className="analysis-map-wrap">
              <SpotLeafletMapWrapper data={analysisResult as import("@/components/map/spot-leaflet-map").SpotMapAnalysis} />
            </div>
          </div>
        ) : fishingPoints ? (
          <div className="mt-4">
