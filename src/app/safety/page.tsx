...
export const metadata: Metadata = {
  title: "釣りの安全ガイド",
  description:
    "釣り中の事故ゼロを目指す安全対策 7 項目を徹底解説。 桜マーク付きライフジャケット選び、 天候・波浪確認、 磯/堤防の転落防止、 オニオコゼ等の毒魚の見分け方、 子ども・家族との安全対策、 緊急連絡先 118 番まで網羅。 釣行前の安全チェックリスト付き。",
  openGraph: {
    title: "釣りの安全ガイド",
    description:
      "釣り中の事故ゼロを目指す安全対策 7 項目を徹底解説。 ライフジャケット選び、 天候確認、 転落防止、 毒魚、 緊急連絡先まで網羅します。",
    type: "article",
