...
export const metadata: Metadata = {
  ...
  description:
    "釣り場の種類・魚種・釣法・時期・天候・経験レベルの 6 項目を選ぶだけでボウズ確率を即診断する無料ツール。 結果に応じてタックル変更・時間帯シフト・代替魚種など具体的な回避策と、 おすすめスポットも自動表示。 釣行前の最終チェックに活用ください。",
  openGraph: {
    title: "ボウズ確率チェッカー｜釣れない対策を事前診断",
    description:
      "釣り場・魚種・時期・天候など 6 項目でボウズ確率を診断。 タックル変更や代替魚種など具体的な回避策まで提案する釣り人必携ツール。",
    type: "website",
