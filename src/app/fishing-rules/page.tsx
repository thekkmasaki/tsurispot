...
export const metadata: Metadata = {
  title: "禁漁期間・漁業権・リリースサイズまとめ - 釣りのルールとマナー",
  description:
    "アユ（10月〜5月）・ヤマメ・イワナ（10月〜2月）など魚種別の禁漁期間の一覧（期間は河川・地域により異なる）をはじめ、漁業権の基礎知識、採ってはいけない魚介類、リリースサイズの目安、釣り禁止区域、釣り場でのマナーまで網羅的にまとめています。",
  openGraph: {
    title: "禁漁期間・漁業権・リリースサイズまとめ - 釣りのルールとマナー",
    description:
      "魚種別の禁漁期間、漁業権の基礎知識、リリースサイズ、釣り禁止区域、マナーまで網羅。",
    type: "article",
