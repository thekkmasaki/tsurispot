...
export function PWAInstallHint() {
  ...
  return (
    // ボトムナビ(60px+safe-area) + 固定広告(99px) + ✕のはみ出し(24px) + 分離(16px) = 215px+safe-area の上へ。
    ...
    <div className="fixed bottom-[calc(215px+env(safe-area-inset-bottom,0px))] left-3 right-3 z-40 md:hidden animate-in slide-in-from-bottom-2 duration-300">
