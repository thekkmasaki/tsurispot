          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex items-center gap-2">
              <button
                onClick={handleAllow}
                disabled={loading}
                className="inline-flex min-h-[44px] items-center gap-1.5 rounded-lg bg-sky-700 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-sky-800 active:bg-sky-900 disabled:opacity-60"
              >
                {loading ? (
                  <>
