...
const SPOT_TYPE_FEATURES: Record<SpotType, {
  ...
  surf: {
    atmosphere: "広大なサーフは、波打ち際に立ちルアーを遠投するダイナミックな釣りが楽しめる",
    merit: "ヒラメ・マゴチなどフラットフィッシュの好ポイント。広大なフィールドで場所取りの心配が少ない",
    caution: "波の状況を常に確認し、ウェーダー着用時は離岸流に注意すること",
    familyTip: "波打ち際は足をすくわれる危険があるため、小さなお子様には不向き。見学を楽しむ程度に",
  },
  lake: {
    atmosphere: "静かな湖畔で、自然に囲まれたゆったりとした釣りが楽しめる",
    merit: "ブラックバスやトラウトなど淡水魚の好ポイント。岸釣りからボート釣りまで楽しめる",
