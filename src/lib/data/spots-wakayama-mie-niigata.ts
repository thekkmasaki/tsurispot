...
export const wakayamaMieNiigataSpots: FishingSpot[] = [
  ...
  // --- 和歌山市エリア ---
  {
    ...
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 287, googleRating: 4.1, googleReviewCount: 31,
    catchableFish: [
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 345, googleRating: 3.8, googleReviewCount: 26,
    catchableFish: [
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ルアー", source: "つり具のマルニシ 和歌山" },
  ...
  },
  {
    ...
    description: "紀ノ川河口はシーバスとヒラメが狙える和歌山の河口ポイント。3〜12月は夕マヅメ〜夜のシーバスが本命で、特に秋のランカーサイズの実績は関西全域のルアーマンに知られる。10〜3月は砂洲まわりでヒラメ、6〜10月はマゴチ、5〜10月はキスの投げ釣りも楽しめる。河川敷に無料駐車スペースがあるが、流れが強くウェーディングにはライフジャケットが必須。",
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 198, googleRating: 3.9, googleReviewCount: 31,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 178, googleRating: 3.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  // --- 御坊・日高エリア ---
  {
    ...
    mainImageUrl: "", images: [], rating: 4.1, reviewCount: 267, googleRating: 4.2, googleReviewCount: 727,
    catchableFish: [
  ...
  // --- 田辺・白浜エリア ---
  {
    ...
    description: "田辺市芳養にある南紀への玄関口となる大規模漁港。潮通しの良い外向きの堤防からはグレ・チヌのフカセ釣り、青物のショアジギングが楽しめる。港内ではサビキでアジの数釣りが可能。アオリイカの一級ポイントとしても名高く、エギンガーに大人気。",
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 245, googleRating: 2.5, googleReviewCount: 2,
    catchableFish: [
  ...
  // --- 串本・すさみエリア ---
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港近くに無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 156, googleRating: 4.2, googleReviewCount: 15,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 11, monthEnd: 5, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
      { fish: fish("aoriika"), monthStart: 4, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ〜日中", method: "エギング" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港横に駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 87, googleRating: 3.4, googleReviewCount: 35,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 11, monthEnd: 5, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
      { fish: fish("aoriika"), monthStart: 4, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ〜日中", method: "エギング" },
  ...
  // --- 新宮・勝浦エリア ---
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港近くに無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 145, googleRating: 3.7, googleReviewCount: 23,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.5, reviewCount: 112, googleRating: 4.2, googleReviewCount: 4114,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "投げ釣り" },
  ...
  // --- 伊勢・南伊勢エリア ---
  {
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 256,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 178, googleRating: 4.2, googleReviewCount: 18,
    catchableFish: [
  ...
  // --- 津・鈴鹿エリア ---
  {
    ...
    description: "日本鋼管突堤（津市）は伊勢湾に突き出す長大な人気釣り場。テトラ帯や堤防先端からキス・クロダイ・カレイの投げ釣りやウキ釣りが楽しめ、秋はタチウオ・シーバスのルアーゲームも本格化する。三重県内でも屈指の人気を誇り、朝夕マヅメは多くの釣り人で賑わう。",
  ...
  },
  {
    ...
    catchableFish: [
      { fish: fish("magochi"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ルアー", source: "カンパリ 白子漁港" },
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "近鉄千代崎駅から徒歩約15分、複数の防波堤に釣り座が分かれる伊勢湾の漁港。ハゼ・キスのちょい投げ・投げ釣りが定番で、9月〜12月はサヨリの回遊、10月〜3月は投げ釣りのカレイも狙える。港内は波が穏やかで、駅近なので電車釣行やファミリーにもおすすめ。",
  ...
  // --- 志摩・鳥羽エリア ---
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港横に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 167, googleRating: 4.6, googleReviewCount: 9,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 11, monthEnd: 5, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
      { fish: fish("aoriika"), monthStart: 4, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ〜日中", method: "エギング" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
  ...
  },
  {
    ...
    description: "鳥羽市の太平洋に面した漁港。海女の町として有名な相差は、磯に恵まれた豊かな海が魅力。春（4〜6月）はエギングでアオリイカ、堤防先端のテトラ帯ではウキ釣りで黒鯛（チヌ）やグレ、夏〜秋はサビキでアジの数釣りが楽しめ、カサゴなどの根魚は一年中狙える。無料駐車場・トイレ完備で、釣り後は相差名物の海鮮料理も楽しめる。",
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港近くに無料駐車場あり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 134, googleRating: 3.7, googleReviewCount: 147,
    catchableFish: [
      { fish: fish("aoriika"), monthStart: 4, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ〜日中", method: "ウキ釣り" },
      { fish: fish("mejina"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 123, googleRating: 3.7, googleReviewCount: 21,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "投げ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港横に駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.5, reviewCount: 198, googleRating: 3.6, googleReviewCount: 71,
    catchableFish: [
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "投げ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ〜日中", method: "投げ釣り" },
  ...
  // --- 新潟市エリア ---
  {
    ...
    mainImageUrl: "", images: [], rating: 4.2, reviewCount: 456,
    catchableFish: [
      { fish: fish("inada"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ルアー" },
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 312, googleRating: 4.1, googleReviewCount: 55,
    catchableFish: [
      { fish: fish("suzuki"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ルアー" },
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  // --- 上越・糸魚川エリア ---
  {
    ...
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 287, googleRating: 3.3, googleReviewCount: 32,
    catchableFish: [
  ...
  // --- 村上・岩船エリア ---
  {
    ...
    description: "岩船港のサビキ釣りは6〜11月のアジが本命。新潟県村上市の日本海に面した大型漁港で、朝マヅメのサビキでアジ・サバ、8〜12月はルアーでカマス、5〜10月は投げ釣りでキス、10〜3月はルアーでヒラメが狙えます。車横付けできる岸壁が多く、港内に無料駐車場とトイレを完備。粟島への連絡船が発着するため、出入港の時間帯は釣り座に注意してください。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 234, googleRating: 3.8, googleReviewCount: 12,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "村上市桑川、国の名勝「笹川流れ」エリアにある漁港。透明度の高い美しい海が特徴で、磯場ではクロダイ・メジナのフカセ釣り、堤防ではサビキでアジ・サバ、エギングでアオリイカが楽しめる。夏の海水浴シーズン以外は比較的釣り人が少なく、穴場的存在。",
  ...
  // --- 佐渡島エリア ---
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 167, googleRating: 5, googleReviewCount: 1,
    catchableFish: [
      ...
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("buri"), monthStart: 9, monthEnd: 1, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング", source: "FishRanker Magazine 佐渡" },
          { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
          { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ" },
    ],
    bestTimes: btEvening,
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.3, reviewCount: 87, googleRating: 3, googleReviewCount: 2,
    catchableFish: [
