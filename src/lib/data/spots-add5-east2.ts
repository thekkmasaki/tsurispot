...
export const eastAdd5Spots2: FishingSpot[] = [
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ヘチ釣り" },
      { fish: fish("tenagaebi"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "エサ釣り" },
    ],
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("karei"), monthStart: 11, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝", method: "投げ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夜", method: "穴釣り" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ヘチ釣り" },
    ],
    bestTimes: btEvening, tackleRecommendations: [], tideAdvice: tidePort, mazumeInfo: mazumeEast,
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("koi"), monthStart: 4, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "吸い込み釣り" },
      { fish: fish("tenagaebi"), monthStart: 5, monthEnd: 9, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "エサ釣り" },
    ],
  ...
  },
  {
    ...
    description: "多摩川丸子橋付近はハゼやテナガエビが釣れる都心の人気ポイント。大田区と川崎市の境を流れ、コイ・フナ・オイカワの淡水釣りから汽水域のシーバス（スズキ）まで多彩に楽しめます。夏はハゼのちょい投げやテナガエビ釣りが手軽で、ファミリーにもおすすめです。",
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ヘチ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夜", method: "ワーム" },
    ],
    bestTimes: btNight, tackleRecommendations: [], tideAdvice: tidePort, mazumeInfo: mazumeEast,
  },
  {
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "メバリング" },
    ],
    bestTimes: btEvening, tackleRecommendations: [], tideAdvice: tidePort, mazumeInfo: mazumeEast,
  },
  {
  ...
  },
  {
    ...
    description: "野比海岸の釣りはシロギスの投げ釣りが定番で、夏場は数釣りが楽しめる。シロギスは5〜10月が最盛期で朝の時間帯が狙い目。冬（11〜3月）はカレイの投げ釣り、初夏から夏（5〜9月）は朝マヅメのマゴチ、春から秋（4〜11月）は夕マヅメのシーバス（スズキ）もルアーで狙える。横須賀市南部の砂浜で、京急YRP野比駅から徒歩約10分。海岸沿いの駐車スペースとトイレ、コンビニがそろう無料の釣り場。",
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("inada"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ショアジギング", source: "魚速報 波崎" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("aji"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
    ],
    bestTimes: btMorning, tackleRecommendations: [], tideAdvice: tideStandard, mazumeInfo: mazumeEast,
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("kurodai"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ルアー" },
      { fish: fish("koi"), monthStart: 4, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "吸い込み釣り" },
    ],
  ...
  },
  {
    ...
    description: "晩秋から春に本領を発揮する、北茨城との県境に近い日立市北部の穴場漁港。10月〜3月は朝の投げ釣りでカレイ、10月〜4月は日中のブラクリでアイナメと、寒い時期ほど釣り物が充実する。春（3月〜6月）は夕マヅメのワームでメバル、暖かい季節の夜はルアーのシーバスも面白い。JR十王駅・常磐道日立北ICのどちらからも車で約10分とアクセスは良好。港近くに駐車スペースがあるがトイレはないため、事前に済ませてから入りたい。",
  ...
  },
  {
    ...
    description: "雄勝港はクロソイ・アイナメ・メバルなど根魚が豊富な三陸海岸の穴場漁港。夜のワームで良型ソイ、春はメバリング、冬はカレイの投げ釣りが狙える。硯の産地として知られる石巻市の静かな漁村で、のんびり竿を出せる。",
  ...
  },
  {
    ...
    description: "牡鹿半島の鮎川港はアジ・サバ・アイナメが狙える宮城の釣り場。かつての捕鯨基地で潮通し抜群、回遊魚の実績が高い港です。夏から秋（7〜10月）は夕マヅメのサビキ釣りでアジ・サバ、秋から春はブラクリでアイナメやクロソイの根魚が大型も期待できます。無料駐車場・トイレを備え、中級者向けながら足場も確保できる釣り場です。",
