...
export const tohokuSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 83, googleRating: 3.8, googleReviewCount: 12,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 91, googleRating: 4, googleReviewCount: 1,
    catchableFish: [
  ...
  },
  {
    ...
    description: "久慈港は冬のアイナメ・クロソイ釣りが本命の港。10〜4月はブラクリのアイナメ、11月以降は夜のワームでクロソイと、寒い時期ほど根魚の釣果が伸びる。夏はサビキのイワシやちょい投げのイシモチで手軽に遊べ、足場が良くファミリーにも向く。久慈駅から徒歩約15分と電車釣行もでき、漁港内に無料駐車スペースとトイレ、近くにコンビニもある。あまちゃんの舞台として知られる港町散策と合わせて楽しめる。漁船の出入りが多いので係留ロープや航路には注意。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 68, googleRating: 4, googleReviewCount: 10,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 82, googleRating: 4, googleReviewCount: 61,
    catchableFish: [
  ...
  },
  {
    ...
    description: "秋田港セリオン前は秋田市の柵付き護岸で安心の釣り場。7〜11月はちょい投げのハゼが本命で、アオイソメのちょん掛けで初心者でも数が伸びる。春〜晩秋は夜のルアーでシーバス、夏はサビキのイワシ、寒い時期は穴釣りのカサゴやメバリングも楽しめる。セリオンタワー前の護岸は柵付きで足場が良く、無料駐車場（100台以上）・トイレ・近隣コンビニと設備が充実。土崎駅から徒歩約20分・秋田北ICから約10分。ファミリーの釣り入門に向いた都市型スポット。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.5, reviewCount: 120, googleRating: 3, googleReviewCount: 2,
    catchableFish: [
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 74, googleRating: 4.3, googleReviewCount: 34,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
      { fish: fish("inada"), monthStart: 8, monthEnd: 11, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 92, googleRating: 4.2, googleReviewCount: 6,
    catchableFish: [
      { fish: fish("hatahata"), monthStart: 11, monthEnd: 1, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夜", method: "サビキ釣り", source: "つり具の上州屋 秋田(東北日本海ハタハタ釣り情報)" },
  ...
  // ========================================
  {
    ...
    description: "女川港はカレイ・アイナメの投げ釣りと根魚が釣れる三陸の釣りポイント。リアス海岸で水深があり、復興後に整備された岸壁は足場も良い。クロソイ・メバル・カサゴのロックフィッシュも通年で楽しめる。駅前に無料駐車場がありアクセスも良好。",
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 145, googleRating: 3.9, googleReviewCount: 138,
    catchableFish: [
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("iwashi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
  ...
  },
  {
    ...
    description: "仙台新港は秋のヒラメ・マゴチ狙いで人気のサーフ釣り場。9〜12月はルアーのヒラメ、6〜10月はマゴチが本命で、朝マヅメの実績が高い。夏はちょい投げのキス、秋冬は投げ釣りのカレイや夜のワームでクロソイも狙える。中野栄駅から車約10分・仙台港ICすぐとアクセスが良く、無料駐車場（50台以上）を完備。近くにコンビニ・釣具店があり餌の調達も便利だが、トイレはないので事前に済ませたい。波の高い日や離岸流に注意し、ライフジャケットを着けて釣行を。",
    ...
    mainImageUrl: "", images: [], rating: 4.2, reviewCount: 210, googleRating: 3.9, googleReviewCount: 83,
    catchableFish: [
      ...
      { fish: fish("kisu"), monthStart: 6, monthEnd: 9, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
          { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ", source: "アングラーズ 仙台漁港" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム", source: "カンパリ 仙台港" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
          { fish: fish("ishimochi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "ちょい投げ" },
  ...
  },
  {
    ...
    description: "石巻漁港は夏秋のサバ・イワシのサビキ釣りが手軽な港。7〜10月は朝マヅメにサバ、6〜10月はイワシの回遊があり、初心者や家族連れでも釣果を出しやすい。晩秋から春はブラクリのアイナメ、夜のワームでクロソイ、投げ釣りのカレイと根魚・底物に主役が替わる。石巻駅から車約10分・石巻港ICから約5分で、無料駐車場とトイレを備え、近隣にコンビニ・釣具店もそろう。水揚げで賑わう現役の漁港のため、漁業作業を優先し係留ロープの近くでは竿を出さないこと。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 132, googleRating: 4.1, googleReviewCount: 10,
    catchableFish: [
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      ...
      { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "ブラクリ" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム", source: "アングラーズ 石巻湾" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
          { fish: fish("ishimochi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "ちょい投げ" },
  ...
  // ========================================
  {
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 105, googleRating: 4, googleReviewCount: 70,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 65, googleRating: 4.3, googleReviewCount: 64,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 6, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("hirame"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ルアー" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 88, googleRating: 3.8, googleReviewCount: 74,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
  ...
  // ========================================
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 72, googleRating: 4.3, googleReviewCount: 15,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    catchableFish: [
      { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ワーム（ロックフィッシュ）", source: "カンパリ" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("ainame"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ブラクリ" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム" },
  ...
  // ========================================
  {
    ...
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
      { fish: fish("hatahata"), monthStart: 11, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夜", method: "サビキ釣り", source: "アングラーズ 男鹿半島" },
          { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.1, reviewCount: 165, googleRating: 3.5, googleReviewCount: 183,
    catchableFish: [
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ルアー" },
      { fish: fish("hirame"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ルアー" },
          ...
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り", source: "釣割 宮城県" },
          { fish: fish("ishimochi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "ちょい投げ" },
    ],
    bestTimes: btStandard, tackleRecommendations: [],
    tideAdvice: tideStandard, mazumeInfo: mazumeTohoku,
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 78, googleRating: 4.3, googleReviewCount: 7,
    catchableFish: [
      { fish: fish("aji"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
  ...
  },
  {
    ...
    description: "いわき市勿来港は投げ釣りでキス・カレイが狙える福島の漁港。福島県最南端、茨城県との県境にあり暖流と寒流が交わる好漁場です。夏はキスのちょい投げ、秋冬はカレイの投げ釣りが本命で、サビキのアジや根魚のメバル・カサゴも楽しめます。無料で駐車場あり。",
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 72, googleRating: 3.7, googleReviewCount: 36,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 6, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
  ...
  // ========================================
  {
    ...
    description: "広田湾はカレイ・アイナメが安定して釣れる穏やかな内湾。奇跡の一本松で知られる陸前高田市に位置し、牡蠣養殖が盛んで波が穏やか。晩秋〜春は投げ釣りでカレイ、ブラクリでアイナメ、夜はワームでクロソイやメバルも狙える。港内に無料駐車スペースあり初心者にも安心。",
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 82, googleRating: 3.3, googleReviewCount: 4,
    catchableFish: [
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ルアー" },
      { fish: fish("aji"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
  ...
  },
  {
    ...
    description: "江名港（いわき市）は根魚とカレイの釣果が安定する太平洋の漁港。水深があり、カサゴ・アイナメ・クロソイの根魚が周年狙え、投げ釣りではカレイやイシモチが本命。夏場はイワシのサビキ釣りも好調で、ファミリーでも楽しめる。",
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 65, googleRating: 3.9, googleReviewCount: 94,
    catchableFish: [
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "穴釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("iwashi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "山形県鶴岡市・鼠ヶ関の沖に浮かぶ弁天島。堤防伝いに歩いて渡れる磯釣り場で、JR鼠ヶ関駅から徒歩約10分と電車釣行もしやすい。10月〜5月はウキフカセでグレ（メジナ）、4月〜11月はクロダイが盛期で、いずれも朝マヅメが狙い目。8月〜11月はショアジギングでイナダの回遊もあり、秋〜春はアイナメ・クロソイ・メバル・カサゴの根魚、投げ釣りのカレイ、ちょい投げのイシモチまで対象魚は9種と多彩。漁港内に無料駐車スペースあり。トイレはない。磯場は滑りやすく、波の高い日は渡島しないこと。日本海の潮通しの良さを活かして大物を狙える無料の磯。",
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 48, googleRating: 3.9, googleReviewCount: 39,
    catchableFish: [
