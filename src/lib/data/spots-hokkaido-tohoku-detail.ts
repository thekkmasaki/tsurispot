...
export const hokkaidoTohokuDetailSpots: FishingSpot[] = [
  ...
  // --- 留萌港 ---
  {
    ...
    slug: "rumoi-ko",
    description:
      "日本海に面した北海道留萌市の主要港で、南防波堤と三泊地区が主な釣り場。足場が広く駐車場やトイレ、コンビニも近いため、初心者やファミリーでも釣りやすい。春はサビキ釣りでホッケ、初夏から秋はルアーでヒラメ、春から晩秋は投げ釣りでカレイが狙える。秋から冬にかけては防波堤の敷石まわりでクロソイ・アイナメ・カサゴの穴釣りやブラクリ、メバリングが楽しめる。朝マヅメ・夕マヅメを中心に、季節ごとの対象魚と仕掛けを押さえれば一年を通して釣果が期待でき、ニシン回遊の歴史が残る港。",
    latitude: 43.9460,
    longitude: 141.6360,
