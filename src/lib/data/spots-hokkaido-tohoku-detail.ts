...
export const hokkaidoTohokuDetailSpots: FishingSpot[] = [
  ...
  // --- 紋別港 ---
  {
    ...
    slug: "monbetsu-ko",
    description:
      "紋別港はカレイ・ホッケ・クロソイが狙えるオホーツクの好釣り場。ガリンコ号で知られる港で、投げ釣りのカレイ、サビキのホッケやハタハタ、穴釣りのカサゴなど四季を通じて楽しめる。無料駐車場とトイレを備え、第2埠頭や南防波堤が主なポイント。",
    latitude: 44.35600,
    longitude: 143.36070,
  ...
  // --- 留萌港 ---
  {
    ...
    slug: "rumoi-ko",
    description:
      "留萌港はホッケ・ヒラメ・カレイが狙える北海道留萌の港。日本海に面した留萌市の主要港で、南防波堤と三泊地区が主な釣り場。足場が広く駐車場やトイレ、コンビニも近いため、初心者やファミリーでも釣りやすい。春はサビキ釣りでホッケ、初夏から秋はルアーでヒラメ、春から晩秋は投げ釣りでカレイが狙える。秋から冬にかけては防波堤の敷石まわりでクロソイ・アイナメ・カサゴの穴釣りやブラクリ、メバリングが楽しめる。朝マヅメ・夕マヅメを中心に、季節ごとの対象魚と仕掛けを押さえれば一年を通して釣果が期待でき、ニシン回遊の歴史が残る港。",
    latitude: 43.9460,
    longitude: 141.6360,
  ...
  // --- 増毛港 ---
  {
    ...
    slug: "mashike-ko",
    description:
      "増毛港はホッケ・ソイが狙える留萌の人気漁港。春はサビキでホッケ、秋〜冬は穴釣りでクロソイやカサゴ、夏はハゼのちょい投げが楽しめる。港周辺に無料駐車スペースがあり、増毛の酒蔵巡りと合わせて初心者でも楽しめる漁港。",
    latitude: 43.85340,
    longitude: 141.53270,
  ...
  // --- 積丹・美国漁港 ---
  {
    ...
    slug: "bikuni-gyoko",
    description:
      "美国漁港は積丹ブルーの海に面した風光明媚な釣り場。春3月はホッケの接岸をサビキ仕掛けで、秋10〜11月はワームでクロソイ・アブラコと、季節で主役が入れ替わる。夏のヒラメや秋のサケ狙いで訪れる釣り人もいるが、サケ・マスは採捕規制があるため必ず最新のルールを確認したい。札幌から約2時間30分、余市から約40分で、港内に駐車スペースとトイレがあり遠征の拠点にしやすい。黄金岬展望台が近く、観光と合わせた釣行にも向く。船揚場や係留ロープの周辺は避けること。",
    latitude: 43.3350,
    longitude: 140.5680,
  ...
  // --- 松前港 ---
  {
    ...
    reviewCount: 72,
    catchableFish: [
      { fish: fish("yariika"), monthStart: 1, monthEnd: 3, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "エサ巻きテーラのウキ釣り・エギング", source: "つり人WEB 松前港" },
  ...
  // --- 岩内港 ---
  {
    ...
    slug: "iwanai-ko",
    description:
      "岩内港はニセコエリアから近い日本海側の港で、ホッケ・カレイ・ソイが好調。旧フェリーターミナルの岸壁が主な釣り場で、春のホッケ釣りは港内が大賑わい。夏はヒラメのルアー、秋はブリの回遊も狙える。",
    latitude: 42.99580,
    longitude: 140.51230,
  ...
  // --- 江差港 ---
  {
    ...
    slug: "esashi-ko",
    description:
      "江差港はホッケ・カレイが狙えるかもめ島隣接の道南の港。江差追分で有名な港町で、防波堤からクロソイやアイナメも釣れ、夏はヤリイカのエギングも盛ん。鷗島からの投げ釣りが定番で、秋冬はメバル・カサゴの穴釣りも楽しめる。",
    latitude: 41.8680,
    longitude: 140.1290,
  ...
  // --- 大間崎 ---
  {
    ...
    slug: "omazaki",
    description:
      "本州最北端、青森県大間町の下北半島に突き出す磯場の釣り場。マグロ一本釣りで知られる地だが、陸からもクロダイ・メバル・クロソイ・アイナメなどのロックフィッシュが狙える。春はホッケのウキ釣りやメバルのワーム、初夏から秋はクロダイのウキ釣り、冬は投げ釣りでカレイと、四季を通じて多彩なターゲットが揃う。津軽海峡の速い潮流に乗って大物が回遊する上級者向けポイントで、足場は岩場のため装備は万全に。大間崎無料駐車場・トイレあり、釣り料金は無料。",
    latitude: 41.5430,
    longitude: 140.9110,
  ...
  // --- 鰺ヶ沢港 ---
  {
    ...
    slug: "ajigasawa-ko",
    description:
      "鰺ヶ沢町の港でアジ・サバのサビキ釣りが盛ん。その名の通りアジがよく釣れることで知られ、夏はアジ・サバ、秋にはハマチ（イナダ）の回遊も狙える。寒い時期はカレイやメバルの根魚釣りも楽しめ、白神山地を望む日本海の好ロケーション。",
    latitude: 40.7790,
    longitude: 140.2150,
  ...
  // --- 竜飛崎 ---
  {
    ...
    slug: "tappizaki",
    description:
      "竜飛崎はクロダイ・マダイ・ヒラマサの大物が狙える津軽半島の磯。津軽海峡の荒波が打ち寄せる超上級者向けポイントで、ウキ釣りやショアジギングが有効です。青函トンネル記念館が近く、階段国道339号の終点としても知られます。根魚のカサゴやクロソイも楽しめます。",
    latitude: 41.2590,
    longitude: 140.3440,
  ...
  // --- 宮古港 ---
  {
    ...
    slug: "miyako-ko",
    description:
      "宮古港は三陸海岸の中心に位置する宮古市の主要港で、カレイ・アイナメ・ソイの根魚釣りが周年楽しめる釣り場。浄土ヶ浜に近い風光明媚なエリアで、夏にはサバやイワシの回遊もある。震災復興後、防波堤が整備され釣りやすくなった。",
    latitude: 39.62870,
    longitude: 141.96470,
  ...
  // --- 釜石港 ---
  {
    ...
    slug: "kamaishi-ko",
    description:
      "カレイ・アイナメ・ドンコなどの底物が好調な釜石市の主要港。「鉄と魚のまち」を象徴する港で、世界最深とされる湾口防波堤（ギネス認定）が広い釣り場を生む。夏にはサバの回遊、秋にはサケの遡上も見られ、釜石大観音が港を見守る。",
    latitude: 39.26860,
    longitude: 141.88510,
  ...
  // --- 石巻港 ---
  {
    ...
    slug: "ishinomaki-ko",
    description:
      "石巻港はシーバス（スズキ）のルアー釣りで全国的に有名な宮城の主要港。旧北上川河口に位置し、港内ではハゼのちょい投げやカレイの投げ釣りが好調。ブラクリのアイナメ、サビキのサバも狙える。石ノ森萬画館に近い。",
    latitude: 38.42640,
  ...
  // --- 気仙沼港 ---
  {
    ...
    slug: "kesennuma-ko",
    description:
      "気仙沼の釣りポイントは内湾のカレイ・アイナメ・ハゼが定番。宮城県気仙沼市の主要港で、10〜3月は投げ釣りでカレイ、9〜12月の朝マヅメはブラクリでアイナメ、7〜11月はちょい投げでハゼ、7〜9月はサビキでサバ・イワシが狙えます。JR気仙沼駅（BRT）から車で約10分、お魚いちば周辺に無料駐車場とトイレがあり、内湾は波が穏やかで初心者でも釣りやすい釣り場です。",
    latitude: 38.88620,
    longitude: 141.59760,
    ...
    catchableFish: [
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("ainame"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ブラクリ", source: "魚速報 気仙沼" },
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 9, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  // --- 塩釜港 ---
  {
    ...
    catchableFish: [
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("ainame"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ブラクリ", source: "アングラーズ 仙台湾" },
      ...
      { fish: fish("hirame"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ルアー" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム", source: "アングラーズ 宮城県" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("ishimochi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "ちょい投げ" },
    ],
  ...
  // --- 酒田港 ---
  {
    ...
    catchableFish: [
      ...
      { fish: fish("iwashi"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("kurodai"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ〜日中", method: "ウキ釣り" },
          { fish: fish("hatahata"), monthStart: 11, monthEnd: 1, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り", source: "つり具の上州屋 酒田店" },
          { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("madai"), monthStart: 4, monthEnd: 6, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "カゴ釣り" },
  ...
  // --- 鼠ヶ関港 ---
  {
    ...
    slug: "nezugaseki-ko",
    description:
      "鼠ヶ関港はクロダイ・マダイのフカセが盛んな磯釣りのメッカ。山形県最南端の県境にあり、弁天島を挟む内港はファミリー向け、外港は上級者向けと住み分けされている。春〜秋はウキ釣り、冬はハタハタのサビキも楽しめる好漁場。",
    latitude: 38.56000,
    longitude: 139.54430,
    ...
    catchableFish: [
      ...
      { fish: fish("kisu"), monthStart: 6, monthEnd: 9, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ〜日中", method: "投げ釣り" },
      { fish: fish("mebaru"), monthStart: 3, monthEnd: 6, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ワーム" },
          { fish: fish("hatahata"), monthStart: 11, monthEnd: 1, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り", source: "釣具の館 酒田店 釣果ブログ" },
          { fish: fish("ainame"), monthStart: 10, monthEnd: 3, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ" },
          { fish: fish("kurosoi"), monthStart: 10, monthEnd: 5, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ワーム" },
    ],
    bestTimes: btMorning,
  ...
  // --- 小名浜港 ---
  {
    ...
    catchableFish: [
      ...
      { fish: fish("aji"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
          ...
          { fish: fish("kamasu"), monthStart: 8, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ルアー釣り" },
    ],
    bestTimes: btEvening,
    tackleRecommendations: [],
