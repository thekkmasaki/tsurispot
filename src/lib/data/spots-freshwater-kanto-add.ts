...
export const freshwaterSpotsKantoAdd: FishingSpot[] = [
  ...
  },
  {
    ...
    description: "埼玉県志木市・新座市を流れる荒川水系の支流。東武東上線志木駅から徒歩約15分で、都心から電車で通える手軽な小物釣り場です。主役は4〜11月のオイカワのウキ釣りで、日中に数釣りが楽しめます。3〜11月はタナゴやマブナ、4〜11月はカワムツやウグイも同じ延べ竿仕掛けで交じり、コイは通年で吸い込み釣りの実績あり。清瀬市の金山橋付近は水質が良く人気のポイントです。料金は無料。専用駐車場はないため公共交通機関の利用がおすすめで、近くにコンビニもあります。増水時は川に近づかないよう注意してください。",
  ...
  },
  {
    ...
    description: "埼玉県日高市・飯能市を流れる清流。圏央道狭山日高ICから約10分、西武線高麗駅から徒歩約15分と都心からのアクセスが良い。曼珠沙華で有名な巾着田周辺が主なポイントで、駐車場（500円/日）やトイレ、コンビニも近く家族連れでも安心。3〜9月はヤマメのエサ釣りが本命で朝マヅメが狙い目。6〜9月はアユの友釣り、4〜11月はウキ釣りのオイカワやカワムツ、エサ釣りのウグイと、身近な川魚の五目釣りが一年の大半で楽しめる。遊漁券は大人800円（1日）。浅く穏やかな流れが多く、渓流釣り入門にも向いた釣り場だ。",
  ...
  },
  {
    ...
    description: "アユの友釣りで関東有数の実績を持つ足柄平野の一級河川。解禁は例年6月1日で、7月が最盛期。開成町から松田町にかけての中流域が友釣りの好ポイントとされる。3月からはヤマメやニジマスも動き出し、下流域では秋から春にかけてルアーのスズキも狙える。遊漁券は大人1日1,500円で、河川敷に無料の駐車スペースがある。中流域は石が大きく歩きにくい場所があるため足元の装備は万全に、増水時の入川は必ず見送ること。小田急線栢山駅から徒歩約10分と、電車釣行しやすい点も魅力。",
  ...
  // ===== 長野県 追加 =====
  {
    ...
    description: "諏訪湖を源とする天竜川の上流域。伊那市・駒ヶ根市周辺はアユの友釣りで有名で、6月〜10月のシーズンには瀬を中心に竿が並び、7月の盛期は特に賑わう。3月〜9月はアマゴのエサ釣りやイワナのフライフィッシングも楽しめ、通年でコイ狙いの吸い込み釣りも可能。釣行には遊漁券（大人1日1,500円）が必要。河川敷に駐車スペースがあり、周辺にコンビニ・釣具店も揃うため遠征でも準備しやすい。中央道伊那ICから約10分、JR伊那市駅から徒歩約15分とアクセス良好。中央アルプスと南アルプスに挟まれた伊那谷の雄大な景色も魅力で、ダム放水時の増水と大石周りの滑りやすさには注意したい。",
  ...
  // ===== 長野県 追加 =====
  {
    ...
    description: "長野県白馬村から新潟県糸魚川市へ注ぎ、フォッサマグナの断層帯を流れる清流。上流域はイワナの好フィールドとして知られ、解禁期の3〜9月にエサ釣りで狙える。ヤマメも同時期にルアーで実績があり、いずれも朝マヅメが狙い目。入川には遊漁券（大人1日1,500円）が必要。入渓ポイント近くに駐車スペースがあるが、トイレはないため白馬市街で済ませておきたい。長野道安曇野ICから約60分、JR白馬駅から車で約5分とアクセスは良好。渓谷部は断崖が続く上級者向けの釣り場で、クマ出没の報告も多くクマ鈴は必携。増水時の入川は避けること。北アルプスの山岳景観と合わせた釣行が楽しめる。",
