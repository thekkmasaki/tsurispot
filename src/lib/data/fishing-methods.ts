 ...
 * 月ごとの概要テキスト（水温特徴）
 */
export const MONTH_CONDITIONS: Record<
  number,
...
> = {
  ...
  9: { waterTemp: "23〜27℃", feature: "残暑で水温は高めだが下旬から下がり始め、秋の荒食いシーズンが開幕する。タチウオや新子のアオリイカなど秋の人気ターゲットが釣れ出し、朝夕のマヅメ時に時合いが集中しやすい。台風の接近が多い時期のため、釣行前の海況確認を徹底したい" },
  10: { waterTemp: "19〜23℃", feature: "水温低下とともに魚が越冬へ向けて荒食いに入り、多くの魚種で釣果が安定する。青物の回遊が本格化してショアジギングの好機となる。日没が早まり夕方の時合いが前倒しになる点には注意。ファミリーにはカワハギやハゼ釣りも楽しみやすい" },
...
const METHOD_HOWTO_DATA: Record<string, HowToData> = {
  ...
  anazuri: {
    steps: [
      { name: "仕掛けをセットする", text: "短めの竿にリールをセットし、道糸の先にブラクリ仕掛け（オモリと針が一体化した仕掛け）を結びます。根掛かりに備えて予備の仕掛けを多めに用意しておきます。" },
      { name: "エサを針に付ける", text: "アオイソメや魚の切り身、サバの身餌などを針に付けます。テトラの奥に落とすため、外れにくいよう針にしっかり刺すのがコツです。" },
      { name: "穴に仕掛けを落とし込む", text: "テトラポッドや石積みの隙間（穴）を見つけ、仕掛けを真っ直ぐ落とし込みます。底まで着いたら糸を張り、オモリで底を小突くように誘います。" },
      { name: "アタリを取って即合わせする", text: "コツコツ・ガツガツという明確なアタリが出たら、間髪入れずに竿を立てて合わせます。根魚は根に潜ろうとするため、合わせが遅れると仕掛けを取られます。" },
      { name: "一気に引き抜いて取り込む", text: "掛けたら根に潜られる前に一気に引き上げます。穴から抜き上げたら魚を針から外し、次の穴へテンポよく移動して探り歩きましょう。" },
    ],
    supply: ["ブラクリ仕掛け（3〜10号、予備多め）", "エサ（アオイソメ・サバの切り身・身餌）"],
    tool: ["短竿（1〜1.5m前後の穴釣り竿・コンパクトロッド）", "小型スピニングまたは両軸リール", "フィッシュグリップ", "クーラーボックス"],
    totalTime: "PT2H",
  },
  jigging: {
    steps: [
      { name: "ジグとタックルを準備する", text: "狙う水深と潮の速さに合わせてメタルジグ（30〜60g）を選びます。PEライン1〜2号にフロロリーダー5〜8号をFGノットで結び、スナップ経由でジグを接続します。" },
      { name: "ポイントへフルキャストする", text: "後方の安全を確認し、堤防先端や潮通しのよいポイントから沖へ向かって思い切り遠投します。飛距離が広範囲を探る鍵になります。" },
      { name: "狙いのタナまで沈める", text: "着水後はラインを送り出し、ジグをカウントしながら底（または狙うタナ）まで沈めます。表層の青物狙いなら着水直後から巻き始めます。" },
      { name: "ジャークでジグを動かす", text: "ロッドを煽りながらリールを巻く「ワンピッチジャーク」が基本。速い動きで誘い、ときどきフォール（沈める間）を入れて食わせの間を作ります。" },
      { name: "ヒットしたらやり取りして取り込む", text: "ガツンと衝撃が来たら大きく合わせます。青物は強烈に走るのでドラグを適正に設定し、無理に巻かず魚の引きをいなしながら寄せ、タモ網で取り込みます。" },
    ],
    supply: ["メタルジグ（30〜60gを複数色・重さ）", "フロロリーダー（5〜8号）", "スナップ・アシストフック"],
    tool: ["ショアジギングロッド（9〜10ft・MH〜H）", "スピニングリール（4000〜6000番）", "PEライン（1〜2号）", "タモ網（長柄）"],
    totalTime: "PT4H",
  },
  oyogase: {
    steps: [
      { name: "エサとなる小魚を確保する", text: "まずサビキ釣りでアジ・イワシ・コアジなどの小魚を釣り、活かしバケツやスカリで生きたまま元気に泳がせておきます。新鮮で元気なエサほど大物に食われやすくなります。" },
      { name: "泳がせ仕掛けをセットする", text: "道糸にウキ仕掛け、または飲ませ用の遊動仕掛け（オモリ・ハリス・親針＋孫針）をセットします。狙う層に応じてウキ下やオモリを調整します。" },
      { name: "生きエサを針に付ける", text: "小魚の鼻先または背中に親針を、尻尾付近に孫針を掛けます。魚が弱らないよう手早く付け、海面にそっと投入します。" },
      { name: "仕掛けを投入してアタリを待つ", text: "堤防先端や潮通しのよい沖目に仕掛けを送り込み、生きエサを自然に泳がせます。竿を置き竿にしてドラグを緩め、大物のアタリをじっくり待ちます。" },
      { name: "本アタリで合わせて取り込む", text: "ウキが消し込む・竿先が大きく舞い込むなど本アタリが出たら、糸を送って魚が完全に食い込むのを待ってから大きく合わせます。大型はタモ網で確実に取り込みましょう。" },
    ],
    supply: ["泳がせ仕掛け（親針＋孫針、ハリス6〜10号）", "オモリ・ウキ", "生きエサ用サビキ仕掛け"],
    tool: ["強めの磯竿・万能竿（3〜4号）", "中〜大型スピニングリール（4000〜6000番）", "活かしバケツ・エアーポンプまたはスカリ", "タモ網"],
    totalTime: "PT5H",
  },
  "entou-kago": {
    steps: [
      { name: "仕掛けをセットする", text: "道糸の先に遠投ウキ、その下にコマセを詰める天秤カゴ、さらにハリス（2〜4号）と針を接続します。ウキ・カゴ・ハリスのバランスを整えるのが遠投と食いの鍵です。" },
      { name: "カゴにコマセを詰める", text: "天秤カゴにオキアミやアミエビのコマセを詰めます。詰めすぎると飛距離が落ちるため、7〜8分目を目安にします。針にも刺しエサ（オキアミ）を付けます。" },
      { name: "沖のポイントへ遠投する", text: "後方の安全を確認し、磯竿のしなりを活かして沖の潮目やナブラへ向かって大きく遠投します。50〜80mの飛距離で広範囲の魚を狙えます。" },
      { name: "タナを合わせてコマセを振り出す", text: "ウキが立ったら設定したタナ（3〜5ヒロが基本）までなじませ、軽く竿をあおってカゴのコマセを海中に拡散させ、刺しエサと同調させます。" },
      { name: "ウキの変化で合わせて取り込む", text: "ウキが勢いよく消し込んだらアタリです。一呼吸おいて大きく合わせ、マダイやイサキの強い引きをドラグでいなしながら寄せ、タモ網で取り込みます。" },
    ],
    supply: ["天秤カゴ（遠投用）", "遠投ウキ", "ハリス・針（ハリス2〜4号）", "コマセ（オキアミ・アミエビ）", "刺しエサ（オキアミ）"],
    tool: ["遠投磯竿（3〜4号、5.3m前後）", "大型スピニングリール（4000〜5000番）", "ナイロンまたはPE道糸", "タモ網・バッカン"],
    totalTime: "PT4H",
  },
};
