...
export const tokyoOsakaBaySpots: FishingSpot[] = [
  ...
  // =========================================
  {
    ...
    catchableFish: [
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ルアー", source: "上州屋" },
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("suzuki"), monthStart: 3, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ルアー", source: "上州屋" },
  ...
  },
  {
    ...
    description: "ふれーゆ裏はタチウオの夜釣りで知られる横浜の人気護岸釣り場。横浜市鶴見区の温水プール施設「ふれーゆ」の裏手に広がり、正式な釣り場ではないが地元では有名なポイント。秋のシーズンには護岸が釣り人で埋まるほどの人気ぶり。アジやイワシのサビキ釣りも安定した釣果があり、常夜灯が多いため夜釣りがしやすい環境。周辺にコンビニがないので食料や飲み物は事前に用意しておきたい。",
    ...
    catchableFish: [
      ...
      { fish: fish("aji"), monthStart: 6, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り", source: "上州屋" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り", source: "上州屋" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー", source: "上州屋" },
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り", source: "上州屋" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り", source: "上州屋" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ルアー", source: "上州屋" },
  ...
  // =========================================
  {
    ...
    catchableFish: [
      ...
      { fish: fish("suzuki"), monthStart: 3, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー", source: "現地情報" },
    ], bestTimes: btEvening, tackleRecommendations: [],
  ...
  },
  {
    ...
    description: "秋のタチウオとサビキのアジが泉大津なぎさ公園の定番。泉大津市の臨海部に整備された護岸公園で、足場が良くファミリーにも向いている。アジ・イワシのサビキは5〜11月、タチウオのウキ釣りは8〜12月が本番。チヌのウキフカセは4〜11月、カサゴの穴釣りは通年成立する。芝生広場があり、子供を遊ばせながらのんびり竿を出せるのも人気の理由。",
