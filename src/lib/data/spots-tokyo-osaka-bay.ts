...
export const tokyoOsakaBaySpots: FishingSpot[] = [
  ...
  },
  {
    ...
    description: "泉大津市の臨海部に整備された公園。護岸からの釣りが楽しめ、足場が良好でファミリーにも適している。サビキ釣りでのアジ・イワシが定番で、秋にはタチウオ狙いの釣り人が増える。チヌのフカセ釣りやカサゴの穴釣りなど、多様な釣り方に対応。芝生広場もあり、子供を遊ばせながらのんびり竿を出せるのが人気の理由。",
