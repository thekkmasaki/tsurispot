...
export const osakaKinkiSpots: FishingSpot[] = [
  // ===== 大阪市エリア（南港・ベイエリア） =====
  {
    ...
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 312, googleRating: 3.9, googleReviewCount: 558,
    catchableFish: [
  ...
  },
  {
    ...
    description: "大阪市住之江区、南港エリア北側の防波堤です。潮通しが良く、5〜11月は朝マヅメのサビキでアジ、4〜10月は日中のサビキでイワシが狙え、初心者やファミリーでも数釣りが成立します。8〜12月は夜のテンヤでタチウオ、9〜12月はエギングでアオリイカ、11〜4月はメバリングと、季節ごとに狙いを変えられるのも魅力。上げ潮のタイミングで群れが入りやすい釣り場です。ニュートラム「ポートタウン西」駅から徒歩約15分で、料金は無料。柵のない区間があるため、足元とライフジャケットに注意してください。",
    ...
    mainImageUrl: "/images/spots/wikimedia/nanko-kita-breakwater.webp", imageAttribution: "Photo: jetsun / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.5, reviewCount: 89, googleRating: 4, googleReviewCount: 3,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 267, googleRating: 3.6, googleReviewCount: 269,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 178, googleRating: 3.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("suzuki"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  // ===== 大正・此花エリア =====
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tsuruhama-gogan.webp", imageAttribution: "Photo: catyasu / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 134, googleRating: 3.1, googleReviewCount: 75,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("suzuki"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  },
  {
    ...
    description: "大阪市此花区の人工島・舞洲の外周護岸。スポーツ施設やバーベキュー場が集まるレジャーアイランドで、遊びと組み合わせた釣行がしやすい。8月〜12月は夜のテンヤで狙うタチウオが盛期で、夕マヅメから夜にかけてが勝負どころ。シーバスは年間を通して夜のルアーで実績があり、5月〜10月は朝マヅメのサビキでアジも釣れる。夢洲方面からの潮流がベイトを運ぶ上げ潮のタイミングが有望。舞洲各施設の駐車場が利用でき、トイレもあるためファミリーでも安心。JR桜島駅からバス約15分「舞洲スポーツアイランド」下車と公共交通でのアクセスも可能。",
    ...
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 156, googleRating: 4, googleReviewCount: 444,
    catchableFish: [
  ...
  // ===== 泉大津エリア =====
  {
    ...
    description: "泉大津市の工業港埠頭。車横付けで竿を出せる手軽さが人気で、5月〜11月はサビキ釣りのアジ、6月〜10月はサバ、4月〜10月はイワシと回遊魚の数釣りが楽しめる。8月〜12月は夜のテンヤでタチウオが本命となり、7月〜10月はカニ網でワタリガニを狙う人も。時合は夕マヅメから夜が中心。無料で釣りができ、路肩駐車可能エリアあり。トイレは無いため事前に済ませたい。阪神高速湾岸線助松出口から約5分。トラックの通行が多い工業地帯のため車の駐め方と荷物の管理に注意。初心者にも向く大阪湾中部の安定ポイント。",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/sukematsu-wharf.webp", imageAttribution: "Photo: Uziuzi / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.7, reviewCount: 198,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
  ...
  // ===== 泉南・岬町エリア =====
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/fuke-port.webp", imageAttribution: "Photo: shikabane taro / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.1, reviewCount: 234, googleRating: 3.8, googleReviewCount: 90,
    catchableFish: [
  ...
  },
  {
    ...
    description: "小島漁港はサビキのアジ釣果が安定する岬町の穴場。5〜11月は朝夕マヅメを中心にアジが釣れ、9〜12月はアオリイカのエギング、3〜11月はフカセ釣りのクロダイも実績がある。紀淡海峡の潮が直接入るため、上げ潮のタイミングが狙い目。波穏やかな港内は足場が安定し、人が少なく落ち着いて竿を出せるのが魅力。漁港周辺に駐車スペースは少数で、トイレはないため事前に準備を。多奈川駅からバス約10分。漁港関係者の作業を優先し、係留ロープ周りは避けること。",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 67, googleRating: 3.9, googleReviewCount: 222,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 78, googleRating: 3.8, googleReviewCount: 56,
    catchableFish: [
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  // ===== 兵庫県（阪神エリア） =====
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/amagasaki-fishing-park.webp", imageAttribution: "Photo: Uziuzi / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.0, reviewCount: 345, googleRating: 3.9, googleReviewCount: 682,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝", method: "サビキ釣り" },
      { fish: fish("suzuki"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/minami-ashiyahama.webp", imageAttribution: "Photo: studio IRONY / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.1, reviewCount: 456,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 287, googleRating: 3.6, googleReviewCount: 71,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
      { fish: fish("suzuki"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  // s220 翼港: spots-additional.ts s116 と重複のため削除
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 123, googleRating: 4.1, googleReviewCount: 143,
    catchableFish: [
  ...
  // ===== 京都府（日本海側） =====
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 89, googleRating: 3.8, googleReviewCount: 100,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/asamogawa-port.webp", imageAttribution: "Photo: YOSHIFUMI OGISO / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.8, reviewCount: 112, googleRating: 4, googleReviewCount: 86,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
