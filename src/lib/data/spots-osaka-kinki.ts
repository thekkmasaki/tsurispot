...
export const osakaKinkiSpots: FishingSpot[] = [
  // ===== 大阪市エリア（南港・ベイエリア） =====
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/seaside-cosmo.jpg", imageAttribution: "Photo: Tokumeigakarinoaoshima / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.9, reviewCount: 312, googleRating: 3.9, googleReviewCount: 558,
    catchableFish: [
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/nanko-kita-breakwater.jpg", imageAttribution: "Photo: jetsun / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.5, reviewCount: 89, googleRating: 4, googleReviewCount: 3,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/kamome-ohashi.jpg", imageAttribution: "Photo: inunami / Wikimedia Commons (CC BY 2.0)", images: [], rating: 4.0, reviewCount: 267, googleRating: 3.6, googleReviewCount: 269,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/nanko-ohashi.jpg", imageAttribution: "Photo: NatsuTV / Wikimedia Commons (CC0)", images: [], rating: 3.8, reviewCount: 178, googleRating: 3.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("seabass"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  // ===== 大正・此花エリア =====
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tsuruhama-gogan.jpg", imageAttribution: "Photo: catyasu / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 134, googleRating: 3.1, googleReviewCount: 75,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("seabass"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/maishima-gogan.jpg", imageAttribution: "Photo: 途方シネマズ / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.7, reviewCount: 156, googleRating: 4, googleReviewCount: 444,
    catchableFish: [
  ...
  // ===== 泉大津エリア =====
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/sukematsu-wharf.jpg", imageAttribution: "Photo: Uziuzi / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.7, reviewCount: 198,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/shiomi-wharf.jpg", imageAttribution: "Photo: Uziuzi / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.6, reviewCount: 145, googleRating: 3, googleReviewCount: 3,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  // ===== 泉南・岬町エリア =====
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/fuke-port.jpg", imageAttribution: "Photo: shikabane taro / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.1, reviewCount: 234, googleRating: 3.8, googleReviewCount: 90,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kojima-port-osaka.jpg", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.8, reviewCount: 67, googleRating: 3.9, googleReviewCount: 222,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tanigawa-port.jpg", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.9, reviewCount: 78, googleRating: 3.8, googleReviewCount: 56,
    catchableFish: [
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  // ===== 兵庫県（阪神エリア） =====
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/amagasaki-fishing-park.jpg", imageAttribution: "Photo: Uziuzi / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.0, reviewCount: 345, googleRating: 3.9, googleReviewCount: 682,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝", method: "サビキ釣り" },
      { fish: fish("seabass"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/minami-ashiyahama.jpg", imageAttribution: "Photo: studio IRONY / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.1, reviewCount: 456,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kobe-airport-veranda.jpg", imageAttribution: "Photo: Joe Jones from Tokyo, Japan / Wikimedia Commons (CC BY-SA 2.0)", images: [], rating: 3.8, reviewCount: 287, googleRating: 3.6, googleReviewCount: 71,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
      { fish: fish("seabass"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  // s220 翼港: spots-additional.ts s116 と重複のため削除
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/fukiage-hama-awaji.jpg", imageAttribution: "Photo: Hasec / Wikimedia Commons (CC0)", images: [], rating: 3.8, reviewCount: 123, googleRating: 4.1, googleReviewCount: 143,
    catchableFish: [
  ...
  // ===== 京都府（日本海側） =====
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tai-port-maizuru.jpg", imageAttribution: "Photo: Yanajin33 / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.7, reviewCount: 89, googleRating: 3.8, googleReviewCount: 100,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/asamogawa-port.jpg", imageAttribution: "Photo: YOSHIFUMI OGISO / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.8, reviewCount: 112, googleRating: 4, googleReviewCount: 86,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 3, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
