...
const kansaiLocalRegions: Region[] = [
  { id: "r300", prefecture: "大阪府", areaName: "泉大津・忠岡", slug: "osaka-izumiotsu-tadaoka" },
  { id: "r301", prefecture: "大阪府", areaName: "岸和田・貝塚", slug: "osaka-kishiwada-kaizuka" },
  { id: "r302", prefecture: "大阪府", areaName: "泉南・りんくう", slug: "osaka-sennan-rinku" },
  { id: "r303", prefecture: "大阪府", areaName: "岬町・淡輪", slug: "osaka-misaki-tannowa" },
  { id: "r304", prefecture: "兵庫県", areaName: "明石・播磨", slug: "hyogo-akashi-harima" },
  { id: "r305", prefecture: "兵庫県", areaName: "姫路・家島", slug: "hyogo-himeji-ieshima" },
  { id: "r306", prefecture: "兵庫県", areaName: "淡路島東部", slug: "hyogo-awaji-east" },
  { id: "r307", prefecture: "和歌山県", areaName: "和歌山市", slug: "wakayama-city" },
  { id: "r308", prefecture: "和歌山県", areaName: "御坊・日高", slug: "wakayama-gobo-hidaka" },
  { id: "r309", prefecture: "和歌山県", areaName: "串本・太地", slug: "wakayama-kushimoto-taiji" },
  { id: "r310", prefecture: "和歌山県", areaName: "勝浦・那智", slug: "wakayama-katsuura-nachi" },
  { id: "r311", prefecture: "京都府", areaName: "伊根・宮津", slug: "kyoto-ine-miyazu" },
  { id: "r312", prefecture: "和歌山県", areaName: "白浜・田辺", slug: "wakayama-shirahama-tanabe" },
  { id: "r313", prefecture: "和歌山県", areaName: "由良・湯浅", slug: "wakayama-yura-yuasa" },
];
...
export const kansaiDetailSpots: FishingSpot[] = [
  ...
  },
  {
    ...
    region: lr("r301"), spotType: "breakwater", difficulty: "intermediate",
  ...
  },
  {
    ...
    region: lr("r302"), spotType: "breakwater", difficulty: "beginner",
  ...
  },
  {
    ...
    region: lr("r304"), spotType: "breakwater", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "護岸沿いに駐車可能（無料）",
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
  ...
  },
  {
    ...
    region: lr("r306"), spotType: "rocky", difficulty: "advanced",
  ...
  },
  {
    ...
    region: lr("r307"), spotType: "port", difficulty: "intermediate",
  ...
  },
  {
    ...
    region: lr("r308"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/placeholder.webp", images: [], rating: 3.7, reviewCount: 167,
    catchableFish: [
  ...
  },
  {
    ...
    region: lr("r313"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/placeholder.webp", images: [], rating: 3.6, reviewCount: 112,
    catchableFish: [
  ...
  },
  {
    ...
    region: lr("r312"), spotType: "port", difficulty: "intermediate",
    isFree: true, hasParking: true, parkingDetail: "港周辺に有料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
  ...
  },
  {
    ...
    region: lr("r309"), spotType: "port", difficulty: "intermediate",
  ...
  },
  {
    ...
    region: lr("r309"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "漁港横に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
  ...
  },
  {
    ...
    region: lr("r310"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港周辺に有料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
