...
export const saninSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    description: "鳥取県の県庁所在地の鳥取市にある主要港湾。鳥取砂丘から近く、防波堤からのアジやイワシのサビキ釣りが人気。秋〜冬はヤリイカのエギングも盛んで、観光ついでに楽しめる釣りスポット。投げ釣り・カゴ釣りと釣り方のバリエーションが豊富です。カレイやマダイやブリなども回遊しており、シーズンを通して楽しめます。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
  ...
  },
  {
    ...
    description: "松葉ガニの水揚げ日本一で知られる境港。水木しげるロードで有名な観光地でもあり、港周辺の防波堤からアジやサバのサビキ釣りが楽しめる。秋〜冬はヤリイカ釣りが最高潮を迎える。エギングやブラクリといった釣り方で多くの釣り人が訪れます。アイナメやマダイやブリも狙えるため、ターゲットの幅が広いのが特徴です。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
  ...
  },
  {
    ...
    description: "鳥取県中部の東伯郡琴浦町にある漁港。日本海に面した小さな漁港だが、アジやイワシのサビキ釣りから、根魚狙いの穴釣りまで楽しめる穴場スポット。冬のヤリイカエギングでも実績がある。投げ釣りと釣り方のバリエーションが豊富です。カサゴやカレイなども回遊しており、シーズンを通して楽しめます。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
  ...
  },
  {
    ...
    description: "鳥取県岩美町の日本海に面した田後港。周囲を岩場と松林に囲まれた風光明媚な港で、アジ・イワシのサビキ釣りが楽しめる。秋から冬はアオリイカやヤリイカの実績も高い漁港。エギングのほか、メバリングでも好釣果が報告されています。時期によってはメバル・マダイ・ブリの釣果も期待できます。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
    ...
    isFree: true, hasParking: true, parkingDetail: "港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/iwami-tago-port.webp", imageAttribution: "Photo: Travis / Wikimedia Commons (CC BY 2.0)", images: [], rating: 3.8, reviewCount: 67, googleRating: 3.6, googleReviewCount: 10,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "鳥取県琴浦町の日本海に面した小規模漁港。アジやメバルの良型が釣れることで地元アングラーに知られる穴場スポット。冬のヤリイカエギングや春〜夏のキス投げ釣りも楽しめる。サビキ釣りやメバリングといった釣り方で多くの釣り人が訪れます。シロギスやマダイやブリも狙えるため、ターゲットの幅が広いのが特徴です。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
    latitude: 35.4670, longitude: 133.6450,
    address: "〒689-2501 鳥取県琴浦町赤碕1735",
    accessInfo: "JR山陰本線浦安駅から車で約10分。山陰自動車道琴浦西ICから約10分。",
    region: localRegion("r191"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港内に無料駐車スペースあり（10台程度）",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kotoura-outtsuka-port.webp", imageAttribution: "Photo: Yoshio Kohara / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 42, googleRating: 3.7, googleReviewCount: 38,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 2, monthEnd: 6, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "メバリング" },
  ...
  // ========================================
  {
    ...
    description: "島根半島の東端に位置する美保関。日本海と中海が交わる潮通しの良いポイントで、アジやサバの大型が釣れることで知られる。美保神社への参拝客も多い風光明媚な漁港。サビキ釣りやショアジギングなど複数の釣法に対応した好ポイントです。イナダ・ヤリイカといった魚種の実績もあります。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
    ...
    mainImageUrl: "/images/spots/wikimedia/matsue-mihonoseki.webp", imageAttribution: "Photo: shikabane taro / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.1, reviewCount: 98,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "縁結びの神様・出雲大社近くの稲佐の浜。神話の地として有名なこの砂浜では、投げ釣りでキスが狙える。観光と組み合わせて楽しめる釣りスポットで、秋には沖合でアオリイカの実績もある。エギング・チョイ投げと釣り方のバリエーションが豊富です。シロギスやカレイやハゼなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/izumo-inasa-beach.webp", imageAttribution: "Photo: mstk east / Wikimedia Commons (CC BY 2.0)", images: [], rating: 3.8, reviewCount: 76, googleRating: 4.5, googleReviewCount: 5399,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
  ...
  },
  {
    ...
    description: "島根県西部の主要港湾・浜田港。浜田漁港は日本有数のカレイ・カサゴ・ノドグロ（アカムツ）の産地。防波堤からのサビキ釣りや投げ釣りが盛んで、ショアジギングでの青物狙いも人気。ブラクリに加えてカゴ釣りも楽しめるため、一日中飽きません。イナダ・アイナメ・マダイの好ポイントとしても地元で知られています。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
  ...
  },
  {
    ...
    description: "島根県最西端に近い益田市の港湾。万葉歌人・柿本人麻呂ゆかりの地でもあり、風光明媚な海岸線が続く。防波堤からのアジ・サバ釣りや、秋のアオリイカエギングが盛んな釣りスポット。サビキ釣りのほか、投げ釣りでも好釣果が報告されています。時期によってはカレイ・マダイ・ブリの釣果も期待できます。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/masuda-port.webp", imageAttribution: "Photo: そらみみ / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.7, reviewCount: 78,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "島根県沖に浮かぶ隠岐の島（島後）の中心港・西郷港。離島の豊かな漁場に囲まれ、大型のクロダイ・グレ・ヒラマサなどが狙える磯釣りの聖地。日本海の荒波に揉まれた魚は引きが強烈。フカセ釣りのほか、ショアジギングでも好釣果が報告されています。時期によってはメジナ・ブリ・アオリイカの釣果も期待できます。中級者以上が腕を試すのに適した環境と魚影が魅力です。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/oki-saigo-port.webp", imageAttribution: "Photo: DassaiOffice / Wikimedia Commons (Public domain)", images: [], rating: 4.5, reviewCount: 213, googleRating: 3.7, googleReviewCount: 7,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "因幡の白うさぎ神話で有名な白兎海岸。鳥取砂丘の西に位置する砂浜で、キスの投げ釣りが盛んなことで知られる。夏場はシロギスの数釣りが楽しめ、秋にはカレイ・ヒラメも回遊する好ポイント。ルアーに加えてチョイ投げも楽しめるため、一日中飽きません。ハゼ・マダイ・ブリの好ポイントとしても地元で知られています。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tottori-hakuto-coast.webp", imageAttribution: "Photo: tomoha / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.9, reviewCount: 86, googleRating: 4.1, googleReviewCount: 482,
    catchableFish: [
  ...
  },
  {
    ...
    description: "名探偵コナンの作者・青山剛昌の出身地として知られる北栄町の砂丘海岸。広大な砂浜が続き、キスの投げ釣りでは県内屈指の実績を誇る。秋のカレイ釣りも人気で、広い釣り場でのんびり楽しめる。ルアーと釣り方のバリエーションが豊富です。シロギスやヒラメなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/hokuei-hojo-dune.webp", imageAttribution: "Photo: soumusoumu / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.7, reviewCount: 52, googleRating: 4, googleReviewCount: 4,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("hirame"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ルアー" },
  ...
  },
  {
    ...
    description: "伯耆大山の山容を望む御来屋漁港。古くからの漁港で、アジやサバのサビキ釣りが盛ん。秋〜冬のヤリイカエギングや、春のメバリングでも実績が高い日本海の好漁場。カゴ釣りに加えてショアジギングも楽しめるため、一日中飽きません。メバル・マダイ・ブリの好ポイントとしても地元で知られています。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
    latitude: 35.4280, longitude: 133.4490,
    address: "〒689-3211 鳥取県大山町御来屋29",
    accessInfo: "JR山陰本線御来屋駅から徒歩約10分。米子自動車道大山高原ICから約30分。",
    region: region("r27"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/daisen-mikuriya-port.webp", imageAttribution: "Photo: rikky_photography / Wikimedia Commons (CC BY 4.0)", images: [], rating: 3.8, reviewCount: 64,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("yariika"), monthStart: 12, monthEnd: 4, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "エギング" },
  ...
  },
  {
    ...
    description: "島根半島の東端に位置する七類港。隠岐の島行きフェリーの発着港で、防波堤からのアジやイワシのサビキ釣りが楽しめる。潮通しが良くブリやヒラマサの回遊もあり、青物狙いのジギングにも好ポイント。ショアジギング・エギングと釣り方のバリエーションが豊富です。hiramasaやヤリイカなども回遊しており、シーズンを通して楽しめます。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/shichirui-port.webp", imageAttribution: "Photo: Aimaimyi / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.0, reviewCount: 88, googleRating: 3.6, googleReviewCount: 17,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("buri"), monthStart: 11, monthEnd: 2, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  },
  {
    ...
    description: "世界遺産・石見銀山に近い仁摩漁港。「砂の美術館」で知られるこの地域の漁港では、アジ・サバのサビキ釣りからカレイの投げ釣りまで楽しめる。秋はアオリイカのエギングの好ポイント。穴釣り・カゴ釣りと釣り方のバリエーションが豊富です。カサゴやマダイやブリなども回遊しており、シーズンを通して楽しめます。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
    latitude: 35.1510, longitude: 132.3060,
    address: "〒699-2301 島根県大田市仁摩町仁万1987-103",
    accessInfo: "JR山陰本線仁万駅から徒歩約15分。山陰自動車道仁摩・石見銀山ICから約10分。",
    region: localRegion("r198"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/oda-nima-port.jpg", images: [], rating: 3.7, reviewCount: 56, googleRating: 3.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "島根県中部の江津市にある波子漁港。アクアスしまね水族館に隣接する港で、アジ・サバのサビキ釣りが人気。夏は青物の回遊もあり、ショアジギングでハマチが狙える。観光ついでに楽しめる好立地。投げ釣りやカゴ釣りなど複数の釣法に対応した好ポイントです。イナダ・カレイ・マダイといった魚種の実績もあります。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/gotsu-hashigo-port.webp", imageAttribution: "Photo: そらみみ / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.6, reviewCount: 48,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "浜田港の外側に位置する瀬戸ヶ島。磯釣りの好ポイントとして知られ、クロダイやグレのフカセ釣りで実績が高い。秋のアオリイカエギングや冬のブリ狙いショアジギングも人気。カゴ釣り・メバリングと釣り方のバリエーションが豊富です。メジナやマダイやメバルなども回遊しており、シーズンを通して楽しめます。ある程度の経験を積んだ釣り人にとってやりがいのあるフィールドです。",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/hamada-setogashima.webp", imageAttribution: "Photo: 三茂屋三下奴 / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.2, reviewCount: 104, googleRating: 4.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
  ...
  },
  {
    ...
    description: "島根県西端に近い飯浦漁港。山口県との県境に位置する小さな漁港で、地元の釣り人に愛される穴場。アジやカレイの定番釣りから、春のメバリングまで楽しめる静かな釣り場。サビキ釣り・投げ釣りと釣り方のバリエーションが豊富です。メバルやカサゴなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/masuda-iinoura-port.jpg", images: [], rating: 3.5, reviewCount: 34, googleRating: 2, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("mebaru"), monthStart: 2, monthEnd: 6, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "メバリング" },
  ...
  },
  {
    ...
    description: "出雲大社の門前町に位置する大社漁港。日本海に面した漁港で、アジやイワシのサビキ釣りが盛ん。秋のアオリイカエギングも人気があり、出雲大社参拝と合わせて楽しむ釣り人も多い。投げ釣りのほか、カゴ釣りでも好釣果が報告されています。時期によってはカレイ・マダイ・ブリの釣果も期待できます。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/izumo-taisha-port.jpg", images: [], rating: 3.8, reviewCount: 72, googleRating: 4.2, googleReviewCount: 19,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "島根半島北側の恵曇（えとも）漁港。松江市街から比較的アクセスの良い漁港で、アジ・サバのサビキ釣りや冬のヤリイカエギングが楽しめる。春にはメバルの実績も高い好漁場。メバリング・カゴ釣りと釣り方のバリエーションが豊富です。マダイやブリやカサゴなども回遊しており、シーズンを通して楽しめます。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
    ...
    isFree: true, hasParking: true, parkingDetail: "港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/matsue-etomo-port.webp", imageAttribution: "Photo: Gkiseki / Wikimedia Commons (CC0)", images: [], rating: 3.7, reviewCount: 58,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("yariika"), monthStart: 12, monthEnd: 4, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "エギング" },
      { fish: fish("mebaru"), monthStart: 2, monthEnd: 6, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "メバリング" },
  ...
  },
  {
    ...
    description: "隠岐諸島の最南端・知夫里島。人口約600人の小さな島だが、磯釣りの宝庫として知られる。大型のクロダイ・グレ・ヒラマサなど、手つかずの自然が育む良型魚が次々とヒットする磯師憧れの離島。フカセ釣りのほか、ショアジギングでも好釣果が報告されています。時期によってはメジナ・hiramasa・イシダイの釣果も期待できます。",
    latitude: 36.0090, longitude: 133.0340,
    address: "〒684-0100 島根県知夫村",
    accessInfo: "七類港からフェリーで約3時間（来居港着）。境港からのルートもあり。",
    region: localRegion("r196"), spotType: "rocky", difficulty: "advanced",
    isFree: true, hasParking: true, parkingDetail: "港付近に駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/oki-chiburijima.webp", imageAttribution: "Photo: KoheiU / Wikimedia Commons (CC0)", images: [], rating: 4.6, reviewCount: 78, googleRating: 4.6, googleReviewCount: 31,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("mejina"), monthStart: 11, monthEnd: 4, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("hiramasa"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  },
  {
    ...
    description: "鳥取港に隣接する賀露みなと。「かにっこ館」や鮮魚直売所がある観光スポットとしても有名。防波堤からのアジ・イワシのサビキ釣りが手軽で、冬はカレイの投げ釣りやヤリイカエギングも盛ん。カゴ釣りやショアジギングといった釣り方で多くの釣り人が訪れます。マダイやブリやメバルも狙えるため、ターゲットの幅が広いのが特徴です。",
    latitude: 35.5260, longitude: 134.2080,
    address: "〒680-0907 鳥取県鳥取市賀露町北4丁目35",
    accessInfo: "JR鳥取駅から車で約15分。鳥取自動車道鳥取ICから約15分。",
    region: region("r27"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "かにっこ館周辺の無料駐車場利用可",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tottori-karo-port.webp", imageAttribution: "Photo: Shuchane56 / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.0, reviewCount: 128, googleRating: 3.7, googleReviewCount: 154,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
