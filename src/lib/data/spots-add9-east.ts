...
export const eastAdd9Spots: FishingSpot[] = [
  ...
  // =========================================
  {
    ...
    description: "本州最東端の重茂半島に位置する宮古市の漁港。三陸の外洋に近く潮通しが良いため根魚の魚影が濃く、3〜12月はブラクリ仕掛けのアイナメ、4〜11月は夜のワームでクロソイと、良型の根魚が長いシーズン狙える穴場的ポイントだ。10月〜翌4月は投げ釣りでカレイも加わり、冬場も竿を出せる。時間帯は朝マヅメが本命。料金は無料で漁港に駐車スペースがあるが、トイレ・コンビニ・釣具店は無いため、宮古市街で準備を済ませてから向かいたい。宮古駅から車で約30分。漁港では漁業関係者の作業を優先し、係留船周りを避けて釣行を。",
  ...
  // =========================================
  {
    ...
    description: "関東屈指のアユの名川・那珂川の中流にあたる烏山の川釣り場。6月〜10月が友釣りのシーズンで、盛期には多くの鮎師で瀬が賑わう。3月〜9月は朝マヅメのルアーでヤマメも狙え、渓流釣りと鮎釣りを一本の川で楽しめるのが強み。友釣りは難度が高く、腕を磨きたい釣り人向けの釣趣が味わえる。遊漁券が必要で日釣券は2,000円前後、周辺に釣具店があるので現地調達もしやすい。河川敷に駐車スペースがあるがトイレはないため準備は事前に。宇都宮上三川ICから車で約40分。",
  ...
  // =========================================
  {
    ...
    description: "三宅島西岸の伊ヶ谷地区にある、黒潮の影響を色濃く受ける漁港。メジナは一年を通してフカセ釣りで狙え、5月〜10月は夕マヅメのカゴ釣りでイサキが有望。7月〜10月にはカンパチの回遊もあり、ショアジギングで一発大物の可能性を秘める。竹芝桟橋からフェリーで約6時間30分の離島だけに、堤防釣りでありながら魚影の濃さは本土の港と一線を画す。漁港に駐車スペースとトイレがあり、島釣り入門の拠点としても使いやすい。",
  ...
  },
  {
    ...
    description: "花暮岸壁は神奈川県三浦市の三崎港にある釣り場です。足場の良い岸壁で、5〜11月は夕マヅメのサビキでアジ、7〜10月は朝マヅメのサビキでサバが狙えます。カサゴは通年、夜のブラクリで釣れます。周辺に有料駐車場とトイレ、コンビニ、釣具店がそろい入場は無料。京急三崎口駅からバスで約15分でアクセスでき、初心者にも向く釣り場です。",
