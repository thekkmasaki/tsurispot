...
export type SearchItemType = "spot" | "fish" | "guide" | "blog" | "tool";
...
// ホーム検索バー用（spot + fish のみ）
export const homeSearchIndex: SearchItem[] = searchIndex.filter(
  (item) => item.type === "spot" || item.type === "fish"
);
