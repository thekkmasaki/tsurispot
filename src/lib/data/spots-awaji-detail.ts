...
export const awajiDetailSpots: FishingSpot[] = [
  ...
  // =========================================
  {
    ...
    description: "生穂漁港（淡路島）はチヌやアジ、タチウオが狙える釣りの穴場。沖に一文字波止があり、津名港からシーバンサーの渡船で渡ることができる。一文字では沖向きでチヌのフカセ釣りやカレイの投げ釣りに実績があり、港内側でもサビキでアジの数釣りが楽しめる。秋にはタチウオの回遊も見られ、ワインドやテンヤで狙える。メバルは冬場の常夜灯周りでのメバリングが面白い。渡船を利用すれば沖の本格的な釣りが楽しめる穴場スポット。",
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング", source: "現地釣果情報" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ〜夕マヅメ", method: "サビキ釣り", source: "現地釣果情報" },
      { fish: fish("suzuki"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "ルアー釣り", source: "現地釣果情報" },
  ...
  },
  {
    ...
    description: "伊毘漁港は秋のアオリイカで釣果実績が高い西海岸の小さな漁港。秋は堤防からのエギングで数が出やすく、キロ級の良型も期待できる。テトラ帯ではメバル・カサゴの根魚釣り、フカセ釣りのチヌにも実績があり、夕方からはアジのサビキ釣りも楽しめる。規模が小さいぶん人が少なく、のんびり竿を出したい人に向く穴場だ。神戸淡路鳴門道の淡路島南ICから車で約15分。路上駐車は禁止されているので駐車場所に注意し、ゴミは必ず持ち帰ろう。",
