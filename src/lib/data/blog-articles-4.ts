...
`,
  },
  {
    ...
    description:
      "釣り竿（ロッド）の種類は磯竿・投げ竿・ルアーロッドが代表格。号数・硬さ・長さの見方と用途別の選び方を一覧で解説します。初心者の1本目には万能に使える磯竿3号・4.5m前後がおすすめ。その理由と失敗しない選び方を紹介。",
    category: "gear",
    tags: ["竿", "ロッド", "磯竿", "初心者"],
    publishedAt: "2026-02-23",
...
`,
  },
  {
    ...
    description:
      "潮がよく動く大潮は回遊魚狙いの最大のチャンス、釣果が安定しやすいのは中潮です。大潮・中潮・小潮・長潮・若潮の5つの潮回りの特徴と釣果への影響、朝マズメ・夕マズメとの関係、潮見表の読み方まで初心者にもわかりやすく解説します。",
    category: "knowledge",
