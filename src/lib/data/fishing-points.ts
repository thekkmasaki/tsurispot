...
export const fishingPointsData: Record<string, SpotDiagramData> = {
  "hiraiso-fishing-park": {
    ...
    facilities: [
      { id: 'f-rest',    name: 'レストハウス', icon: '🏠' },
      { id: 'f-bbq',     name: 'BBQ場',        icon: '🍖' },
      { id: 'f-office',  name: '管理事務所',   icon: '🏢' },
      { id: 'f-gate',    name: '料金所',       icon: '🎫' },
      { id: 'f-shop',    name: '売店',         icon: '🏪' },
      { id: 'f-vending', name: '自販機',       icon: '🥤' },
      { id: 'f-parking', name: '駐車場',       icon: '🅿️' },
    ],
    ...
    seaFeatures: [
      { name: 'テトラ帯',       icon: '▓', left: 2,  width: 18 },
      { name: '捨石魚礁',       icon: '◆', left: 24, width: 20 },
      { name: 'コンクリート魚礁', icon: '◆', left: 48, width: 18 },
      { name: '六角錐魚礁',     icon: '◆', left: 72, width: 18 },
    ],
