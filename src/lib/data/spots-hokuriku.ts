...
export const hokurikuSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    description: "上越市の日本海に面した大港。広い岸壁でサビキ釣りからショアジギングまで楽しめる。春のホタルイカ接岸時期は特に賑わう。ウキフカセやカゴ釣りなど複数の釣法に対応した好ポイントです。サバ・クロダイ・イナダといった魚種の実績もあります。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。岸壁の足場がしっかりしており、安定した体勢で竿を振れます。",
  ...
  },
  {
    ...
    description: "魚のアメ横と呼ばれる鮮魚市場に隣接した港。アジやキスが安定して釣れ、観光と釣りを同時に楽しめる人気スポット。サビキ釣り・ちょい投げと釣り方のバリエーションが豊富です。シロギスやメバルなども回遊しており、シーズンを通して楽しめます。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。駐車場・トイレ・コンビニが整備されており、快適に釣行できます。",
  ...
  },
  {
    ...
    description: "信濃川河口に近い新潟西港。シーバスの名ポイントとして知られ、秋のサケ遡上シーズンも見もの。都市型の便利な釣り場。ルアーやサビキ釣りなど複数の釣法に対応した好ポイントです。アジ・クロダイ・マダイといった魚種の実績もあります。中級者以上が腕を試すのに適した環境と魚影が魅力です。駐車場やトイレやコンビニが近くにあるため長時間の釣りでも安心です。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/niigata-nishi-port.jpg", images: [], rating: 3.8, reviewCount: 132, googleRating: 3.3, googleReviewCount: 4,
    catchableFish: [
  ...
  },
  {
    ...
    description: "柏崎市の中心部に近い港。堤防が長く伸び、アジやサバのサビキ釣りからエギングまで多彩。夕日が美しいスポットとしても知られる。穴釣りやカゴ釣りなど複数の釣法に対応した好ポイントです。アオリイカ・カサゴ・マダイといった魚種の実績もあります。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。堤防からの釣りは足場の安定感と魚種の豊富さが両立するのが強みです。",
  ...
  },
  {
    ...
    description: "佐渡島南端のたらい舟で有名な港。離島ならではの魚影の濃さで、アジ・メバル・クロダイなど多彩な魚種が釣れる。サビキ釣りやウキフカセなど複数の釣法に対応した好ポイントです。アオリイカ・マダイ・カサゴといった魚種の実績もあります。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。周辺には駐車場やトイレがあり、釣り環境として不便がありません。",
  ...
  // ========================================
  {
    ...
    description: "寒ブリで全国的に有名な氷見の漁港。堤防からはアジやキスが釣れ、冬場のヤリイカ狙いのエギングも人気。立山連峰を望む絶景。サビキ釣りのほか、ちょい投げでも好釣果が報告されています。時期によってはシロギス・クロダイの釣果も期待できます。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
  ...
  },
  {
    ...
    description: "蜃気楼の街・魚津の補助港。埋没林博物館の近くで、ホタルイカの名所でもある。アジやカマスが安定して釣れる穴場スポット。サビキ釣りに加えてルアーも楽しめるため、一日中飽きません。カサゴ・マダイ・メバルの好ポイントとしても地元で知られています。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。足場が整っているため安全に釣りを楽しめます。",
  ...
  },
  {
    ...
    description: "富山湾の奥に位置する新湊漁港。シロエビやホタルイカの水揚げで有名。堤防からのアジングやキス釣りが人気で、内海のため穏やかな日が多い。ちょい投げのほか、カゴ釣りでも好釣果が報告されています。時期によってはシロギス・ハゼ・マダイの釣果も期待できます。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。",
    latitude: 36.7760, longitude: 137.1080,
    address: "〒933-0222 富山県射水市海竜町",
  ...
  },
  {
    ...
    description: "黒部川河口近くの漁港。河口からはシーバスやヒラメが、堤防からはアジやカマスが狙える。秋のサケ遡上も見られる。ルアーやサビキ釣りなど複数の釣法に対応した好ポイントです。マダイ・メバル・カサゴといった魚種の実績もあります。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。駐車場が整備されており、快適に釣行できます。",
  ...
  // ========================================
  {
    ...
    description: "金沢市内からアクセス抜群の整備された釣り護岸。柵付きの護岸でファミリーに最適。アジやキスを中心に多彩な魚種が狙える。サビキ釣りのほか、ちょい投げでも好釣果が報告されています。時期によってはシロギス・クロダイの釣果も期待できます。堤防からの釣りは足場の安定感と魚種の豊富さが両立するのが強みです。駐車場とトイレとコンビニが利用可能で、実用面でも優れた釣り場です。",
    latitude: 36.6120, longitude: 136.6180,
    address: "〒920-0331 石川県金沢市大野町4丁目リ",
    accessInfo: "北陸鉄道大野港バス停から徒歩約10分。北陸自動車道金沢西ICから約15分。",
    region: localRegion("r148"), spotType: "breakwater", difficulty: "beginner",
  ...
  },
  {
    ...
    description: "能登島の東側に位置する静かな漁港。クロダイやメバルの好ポイントで、エギングでアオリイカも狙える。のとじま水族館にも近い。ウキフカセ・メバリングと釣り方のバリエーションが豊富です。マダイやカサゴやブリなども回遊しており、シーズンを通して楽しめます。経験者が通い込むだけの実力を秘めた釣り場です。周辺には駐車場があり、釣り環境として不便がありません。",
  ...
  },
  {
    ...
    description: "朝市で有名な輪島の港。奥能登の潮通しの良い海域で、根魚やイカの好ポイント。観光と組み合わせた釣行にも最適。穴釣りやエギングなど複数の釣法に対応した好ポイントです。カサゴ・アオリイカ・アジといった魚種の実績もあります。中級者以上が腕を試すのに適した環境と魚影が魅力です。駐車場やトイレが近くにあるため長時間の釣りでも安心です。",
    latitude: 37.39280, longitude: 136.9000,
    address: "〒928-0008 石川県輪島市マリンタウン",
  ...
  },
  {
    ...
    description: "七尾湾に面した穏やかな港。アジのサビキ釣りやキスのちょい投げが中心で、初心者やファミリーに向いた釣り場。カゴ釣りやメバリングといった釣り方で多くの釣り人が訪れます。シロギスやハゼやマダイも狙えるため、ターゲットの幅が広いのが特徴です。堤防の先端付近は潮通しが良く、回遊魚の寄りが期待できます。岸壁の足場がしっかりしており、安定した体勢で竿を振れます。",
  ...
  // ========================================
  {
    ...
    description: "北陸屈指の人気釣りスポット。広い岸壁から多彩な魚種が狙え、アジ・サバのサビキ釣りから青物のショアジギまで楽しめる。エギングやショアジギングなど複数の釣法に対応した好ポイントです。アオリイカ・イナダといった魚種の実績もあります。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。岸壁の足場がしっかりしており、安定した体勢で竿を振れます。",
  ...
  },
  {
    ...
    description: "九頭竜川河口に位置する三国港。堤防先端は潮通しが良く、クロダイやシーバスの好ポイント。夕陽の名所としても有名。ウキフカセやルアーといった釣り方で多くの釣り人が訪れます。アジやマダイやメバルも狙えるため、ターゲットの幅が広いのが特徴です。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
  ...
  },
  {
    ...
    description: "若狭湾に面した古くからの漁港。アジやカマスが年中釣れ、秋のアオリイカシーズンは県外からも多くの釣り人が訪れる。サビキ釣りに加えてルアーも楽しめるため、一日中飽きません。メバルの好ポイントとしても地元で知られています。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。足場が整っているため安全に釣りを楽しめます。",
  ...
  },
  {
    ...
    description: "越前がにで有名な漁港。冬季のカニ漁で賑わうが、春から秋はアジやイカの好釣り場。磯場も近く多彩な釣りが楽しめる。サビキ釣り・エギングと釣り方のバリエーションが豊富です。アオリイカやメジナやカサゴなども回遊しており、シーズンを通して楽しめます。経験者が通い込むだけの実力を秘めた釣り場です。周辺には駐車場やトイレがあり、釣り環境として不便がありません。",
  ...
  // ========================================
  {
    ...
    description: "ヒスイ海岸で有名な糸魚川市の港。北アルプスと日本海が交わる景勝地で、アジやキスが安定して釣れる。秋のサゴシ回遊も人気。サビキ釣りに加えてちょい投げも楽しめるため、一日中飽きません。シロギス・サワラ・マダイの好ポイントとしても地元で知られています。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
    latitude: 37.0480, longitude: 137.8580,
    address: "〒941-0066 新潟県糸魚川市寺島976-1",
  ...
  },
  {
    ...
    description: "良寛の里として知られる出雲崎の漁港。佐渡島を望む夕日の名所で、アジやメバルが安定して釣れる穴場スポット。サビキ釣りやメバリングといった釣り方で多くの釣り人が訪れます。クロダイやマダイやカサゴも狙えるため、ターゲットの幅が広いのが特徴です。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
  ...
  },
  {
    ...
    description: "カニの直売所で有名な能生の漁港。日本海に面した港で、アジやキスの釣果が安定。春のホタルイカ接岸時期は漁港が賑わう。サビキ釣りやちょい投げなど複数の釣法に対応した好ポイントです。シロギス・アオリイカ・マダイといった魚種の実績もあります。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。駐車場・トイレ・コンビニが整備されており、快適に釣行できます。",
  ...
  // ========================================
  {
    ...
    description: "ホタルイカの聖地・滑川市の漁港。春のホタルイカ身投げが名物で、堤防からアジやカマスが安定して釣れる。富山湾の深い海が育む豊かな漁場。サビキ釣りに加えてルアーも楽しめるため、一日中飽きません。ヤリイカ・マダイ・メバルの好ポイントとしても地元で知られています。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。",
  ...
  },
  {
    ...
    description: "富山市内からアクセス抜群の都市型漁港。富山港に隣接し、アジやキスの数釣りが楽しめる。ライトレールの終点からすぐ。サビキ釣り・ちょい投げと釣り方のバリエーションが豊富です。シロギスやシーバスやマダイなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    latitude: 36.7410, longitude: 137.2280,
    address: "〒931-8378 富山県富山市岩瀬天神町265",
  ...
  // ========================================
  {
    ...
    description: "能登半島最先端に近い蛸島漁港。奥能登の海は魚影が濃く、アジやメバルの好ポイント。静かな漁村で本格的な釣りが楽しめる。サビキ釣りのほか、メバリングでも好釣果が報告されています。時期によってはアオリイカ・マダイ・カサゴの釣果も期待できます。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
  ...
  },
  {
    ...
    description: "千里浜なぎさドライブウェイの近くにある滝港。日本海に面した好漁場で、アジやキスが安定して釣れる。春のホタルイカ接岸も見られる。サビキ釣りに加えてちょい投げも楽しめるため、一日中飽きません。シロギス・カサゴの好ポイントとしても地元で知られています。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
    latitude: 36.92230, longitude: 136.75430,
    address: "〒925-0005 石川県羽咋市滝町レ101",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/hakui-taki-port.jpg", images: [], rating: 3.6, reviewCount: 62, googleRating: 3.9, googleReviewCount: 18,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 6, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "穴釣り" },
  ...
  // ========================================
  {
    ...
    description: "若狭湾に面した大飯郡おおい町の漁港。若狭湾の穏やかな海でアジやメバルが安定して釣れ、エギングでのアオリイカも人気。サビキ釣り・メバリングと釣り方のバリエーションが豊富です。マダイやカサゴやブリなども回遊しており、シーズンを通して楽しめます。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。駐車場が近くにあるため長時間の釣りでも安心です。",
  ...
  },
  {
    ...
    description: "若狭湾西端に位置する高浜町の漁港。日本海の荒波を受ける外海側はクロダイやグレの磯釣りポイント。内側は穏やかでファミリーにも最適。ウキフカセやサビキ釣りといった釣り方で多くの釣り人が訪れます。アジやアオリイカも狙えるため、ターゲットの幅が広いのが特徴です。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
  ...
  // ========================================
  {
    ...
    description: "新潟市北部の聖籠町にある海水浴場横の釣りポイント。広いサーフからキスの投げ釣りが楽しめ、夏場は家族連れに人気。ちょい投げやルアーなど複数の釣法に対応した好ポイントです。シロギス・ヒラメ・ハゼといった魚種の実績もあります。駐車場やトイレが近くにあるため長時間の釣りでも安心です。釣り場への入場は無料で、コストを抑えた釣行が可能です。",
    latitude: 38.00180, longitude: 139.26160,
    address: "〒957-0103 新潟県聖籠町網代浜",
  ...
  },
  {
    ...
    description: "高岡市の伏木港は万葉集の歌人・大伴家持ゆかりの地。古くからの交易港で、アジやカマスの釣果が安定。秋にはイナダの回遊も。サビキ釣りに加えてルアーも楽しめるため、一日中飽きません。マダイ・メバル・カサゴの好ポイントとしても地元で知られています。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。駐車場とトイレとコンビニが利用可能で、実用面でも優れた釣り場です。",
    latitude: 36.78060, longitude: 137.04890,
    address: "〒934-0001 富山県射水市庄西町2丁目4",
  ...
  },
  {
    ...
    description: "加賀温泉郷に近い橋立港。カニ漁で有名だが、堤防からアジやメバルが安定して釣れる。温泉旅行の合間に気軽に楽しめる。サビキ釣りやメバリングなど複数の釣法に対応した好ポイントです。カサゴといった魚種の実績もあります。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。駐車場とトイレが利用可能で、実用面でも優れた釣り場です。",
    latitude: 36.3210, longitude: 136.2460,
    address: "〒922-0552 石川県加賀市田尻町浜山2-11",
  ...
  },
  {
    ...
    description: "福井市北部の鷹巣漁港。越前海岸の景勝地に位置し、磯釣りとエギングの人気スポット。透明度の高い海で多彩な魚種が狙える。ウキフカセやサビキ釣りなど複数の釣法に対応した好ポイントです。アオリイカ・メジナ・アジといった魚種の実績もあります。ある程度の経験を積んだ釣り人にとってやりがいのあるフィールドです。駐車場とトイレが利用可能で、実用面でも優れた釣り場です。",
  ...
  },
  {
    ...
    description: "新潟県最北の村上市にある小さな漁港。笹川流れの景勝地内に位置し、透明度の高い海でアジやメバルが狙える穴場スポット。サビキ釣りのほか、メバリングでも好釣果が報告されています。時期によってはクロダイの釣果も期待できます。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。駐車場が利用可能で、実用面でも優れた釣り場です。",
    latitude: 38.2410, longitude: 139.5560,
    address: "〒959-3946 新潟県村上市寝屋149",
  ...
  },
  {
    ...
    description: "白山市の手取川河口近くの漁港。フグの産地として知られ、堤防からアジやカマスが安定して釣れる。シーバスのポイントとしても有名。サビキ釣りやルアーといった釣り方で多くの釣り人が訪れます。マダイやメバルやカサゴも狙えるため、ターゲットの幅が広いのが特徴です。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
    latitude: 36.5110, longitude: 136.5780,
    address: "〒929-0235 石川県白山市美川永代町",
