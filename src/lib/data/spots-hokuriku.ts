...
export const hokurikuSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    description: "新潟市北部・聖籠町網代浜は、広いサーフから手軽に楽しめる海水浴場横の釣りポイント。夏（6〜9月）はキスのちょい投げが最盛期で初心者やファミリーに人気、秋にはハゼやアオリイカ、9月以降はブリのショアジギングなど青物の回遊も狙える。冬場はメバル・カサゴ・アイナメの根魚、ヒラメやカレイの投げ釣りも実績あり。トイレ完備で無料、アクセスや仕掛けも詳しく解説。",
