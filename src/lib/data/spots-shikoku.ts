...
export const shikokuSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/takamatsu-tamamo-park.jpg", imageAttribution: "Photo: yano@mama.akari.ne.j… / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.7, reviewCount: 135, googleRating: 3.8, googleReviewCount: 45,
    catchableFish: [
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/takuma-port.jpg", imageAttribution: "Photo: ラハール / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.8, reviewCount: 92,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/sakaide-bannosu.jpg", imageAttribution: "Photo: ccfarmer / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 108,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/marugame-port.jpg", imageAttribution: "Photo: iPhone修理/カスタマイズパーツ販売… / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.5, reviewCount: 85, googleRating: 4, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
  ...
  // ========================================
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/naruto-uchinoumi-fishing.jpg", imageAttribution: "Photo: Gohachiyasu1214 / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.0, reviewCount: 115, googleRating: 4.3, googleReviewCount: 1075,
    catchableFish: [
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
  ...
  },
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/anan-gamoda-cape.jpg", imageAttribution: "Photo: akiakane / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.3, reviewCount: 62, googleRating: 4.2, googleReviewCount: 39,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tokushima-okisu.jpg", imageAttribution: "Photo: 瀬部 嵐 / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.5, reviewCount: 108, googleRating: 4, googleReviewCount: 522,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  // ========================================
  {
    ...
    hasToilet: false, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/susaki-shinjo-river.jpg", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.8, reviewCount: 72,
    catchableFish: [
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/katsurahama-tanezaki.jpg", imageAttribution: "Photo: r18 INO (PACHIMO) / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.7, reviewCount: 82, googleRating: 5, googleReviewCount: 2,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tosashimizu-iburi.jpg", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.1, reviewCount: 55, googleRating: 2.5, googleReviewCount: 2,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 10, monthEnd: 5, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kochi-kokadai.jpg", imageAttribution: "Photo: minamikaze / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.5, reviewCount: 92,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/imabari-port.jpg", imageAttribution: "Photo: DVMG / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.8, reviewCount: 128, googleRating: 4.2, googleReviewCount: 30,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/matsuyama-gaiko.jpg", imageAttribution: "Photo: DVMG / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 145, googleRating: 4.7, googleReviewCount: 9,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/uwajima-port-fishing.jpg", imageAttribution: "Photo: 宇和島太郎 / Wikimedia Commons (Public domain)", images: [], rating: 3.9, reviewCount: 88, googleRating: 3.8, googleReviewCount: 14,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/sadamisaki-misaki-port.jpg", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.2, reviewCount: 62, googleRating: 4, googleReviewCount: 492,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/yawatahama-port-fishing.jpg", imageAttribution: "Photo: Higa4 / Wikimedia Commons (CC0)", images: [], rating: 3.7, reviewCount: 95, googleRating: 3.9, googleReviewCount: 167,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "穴釣り" },
  ...
  // ========================================
  {
    ...
    mainImageUrl: "/images/spots/wikimedia/mugi-port.jpg", imageAttribution: "Photo: Tomohide SUGIMOTO from Kyoto, Japan / Wikimedia Commons (CC BY 2.0)", images: [], rating: 4.0, reviewCount: 68, googleRating: 3.8, googleReviewCount: 79,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 10, monthEnd: 5, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/muroto-misaki-port.jpg", imageAttribution: "Photo: Ervaar Japan / Wikimedia Commons (CC BY 2.0)", images: [], rating: 4.4, reviewCount: 72, googleRating: 3.4, googleReviewCount: 5,
    catchableFish: [
      { fish: fish("ishidai"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "石鯛仕掛け" },
      { fish: fish("mejina"), monthStart: 10, monthEnd: 5, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
      { fish: fish("kanpachi"), monthStart: 7, monthEnd: 10, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/nakatosa-kure-port.jpg", imageAttribution: "Photo: Navian / Wikimedia Commons (Public domain)", images: [], rating: 3.9, reviewCount: 82, googleRating: 4.1, googleReviewCount: 2729,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/ainan-fukaurako.jpg", imageAttribution: "Photo: Meii1122 / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.1, reviewCount: 55, googleRating: 2, googleReviewCount: 1,
    catchableFish: [
      { fish: fish("mejina"), monthStart: 10, monthEnd: 5, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
      { fish: fish("aoriika"), monthStart: 3, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/saijo-toyo-port.jpg", imageAttribution: "Photo: キアラア / Wikimedia Commons (CC0)", images: [], rating: 3.5, reviewCount: 78, googleRating: 4.2, googleReviewCount: 154,
    catchableFish: [
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/shimanami-omishima.jpg", imageAttribution: "Photo: そらみみ / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.1, reviewCount: 68, googleRating: 4.2, googleReviewCount: 138,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kuroshio-irino-port.jpg", imageAttribution: "Photo: Ryuichiro Kasatani / Wikimedia Commons (CC0)", images: [], rating: 3.7, reviewCount: 58,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("hirame"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ルアー" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kanonji-port.jpg", imageAttribution: "Photo: TheKjozk / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.6, reviewCount: 85, googleRating: 3.5, googleReviewCount: 23,
    catchableFish: [
      { fish: fish("tachiuo"), monthStart: 8, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tosa-usa-port.jpg", imageAttribution: "Photo: r18 INO (PACHIMO) / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.7, reviewCount: 72, googleRating: 3.8, googleReviewCount: 20,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kamasu"), monthStart: 8, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ルアー" },
      { fish: fish("kurodai"), monthStart: 3, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ウキフカセ" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/iyo-futami-seaside.jpg", imageAttribution: "Photo: わずかな時間を見つけて / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.8, reviewCount: 62, googleRating: 4.2, googleReviewCount: 592,
    catchableFish: [
      { fish: fish("kisu"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("aji"), monthStart: 5, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "メバリング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/seiyo-mikame-port.jpg", imageAttribution: "Photo: Earth Science and Remote Sensing Unit, Lyndon B. / Wikimedia Commons (Public domain)", images: [], rating: 3.8, reviewCount: 62,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "日中", method: "穴釣り" },
