...
export const eastAdd5Spots3: FishingSpot[] = [
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("brown-trout"), monthStart: 4, monthEnd: 9, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ルアー" },
    ],
    bestTimes: btMorning, tackleRecommendations: [], tideAdvice: tideRiver, mazumeInfo: mazumeInland,
  },
  {
  ...
  },
  {
    ...
    description: "秋田県由利本荘市岩城道川にある日本海に面した小さな漁港。春（3〜6月）はワームでメバル、夏から秋（7〜10月）はサビキでアジが狙え、初冬（11〜1月）のハタハタ接岸期は特に注目を集める。クロダイのウキフカセやカサゴの穴釣りも年間を通じて楽しめる。港周辺に駐車スペースがあり無料で釣りができるが、トイレはないため事前準備を。JR道川駅から徒歩約10分、日本海東北自動車道岩城ICから約5分とアクセス良好。",
  ...
  // =========================================
  {
    ...
    catchableFish: [
      ...
      { fish: fish("kasago"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夜", method: "穴釣り" },
      { fish: fish("hokke"), monthStart: 3, monthEnd: 6, peakSeason: false, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ウキ釣り" },
    ],
    bestTimes: btMorning, tackleRecommendations: [], tideAdvice: tidePort, mazumeInfo: mazumeNorth,
  },
  {
  ...
  },
  {
    ...
    description: "豊浦漁港（北海道豊浦町）は噴火湾に面した釣り場。4〜6月はカレイの投げ釣りが本命で、3〜5月はホッケをサビキ釣りやウキ釣りで狙える。夜はクロソイがワームで通年ねらえる。港周辺に無料の駐車スペースがあり、JR豊浦駅から車で約5分、道央自動車道豊浦ICから約5分。トイレはないため到着前に済ませておきたい。",
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("ainame"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "日中", method: "ブラクリ" },
      { fish: fish("kasago"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夜", method: "穴釣り" },
      { fish: fish("aoriika"), monthStart: 8, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
    ],
    bestTimes: btMorning, tackleRecommendations: [], tideAdvice: tideStandard, mazumeInfo: mazumeNorth,
  },
  {
  ...
  // =========================================
  {
    ...
    catchableFish: [
      ...
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "ヘチ釣り" },
    ],
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("magochi"), monthStart: 5, monthEnd: 9, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ルアー" },
  ...
  },
  {
    ...
    catchableFish: [
      ...
      { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "ワーム" },
      { fish: fish("kasago"), monthStart: 1, monthEnd: 12, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夜", method: "穴釣り" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
    ],
  ...
  },
  {
    ...
    description: "鵜原漁港は景勝地・鵜原理想郷の近く、磯が隣接する静かな漁港。磯場が近いため、漁港ながらウキフカセのメジナや石鯛仕掛けのイシダイと本格的な磯釣りの対象が揃い、腕試しをしたい中級者に向く。港内は波穏やかで足場が良く、車を横付けできる釣り座もあるので荷物が多くても楽だ。ベストシーズンは秋10月。JR鵜原駅から徒歩約10分と電車釣行も可能。係留船のロープ周りを避け、地元漁業者への配慮を忘れずに楽しみたい。",
