...
export const additionalSpotsOkinawa: FishingSpot[] = [
  // ===== 沖縄県 (r17) s101-s103 =====
  {
    ...
    name: "宜野湾マリーナ",
    slug: "ginowan-marina",
    description: "宜野湾マリーナは足場の良い護岸から竿を出せる沖縄本島中部の釣り場。整備されたマリーナ施設内にあり、初心者や家族連れでも安心して釣りができる。定番はサビキ釣りのアジとウキフカセのクロダイ（チヌ）で、時間帯は朝マヅメ・夕マヅメが有望。サンゴ礁域のため、魚が浅場に差してくる上げ潮のタイミングを合わせると釣果が伸びやすい。無料駐車場とトイレを備え、近くにコンビニもあるので手ぶら感覚の気軽な釣行に向く。那覇空港から車で約30分、北中城ICから約10分と観光の合間にも立ち寄りやすい。日差しが強い土地柄、日焼け対策は季節を問わず必須。",
    latitude: 26.277732,
    longitude: 127.729564,
