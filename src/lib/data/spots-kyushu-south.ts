...
export const kyushuSouthSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 98, googleRating: 4.5, googleReviewCount: 40,
    catchableFish: [
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 87,
    catchableFish: [
  ...
  },
  {
    ...
    description: "津久見港は9〜10月の秋に釣果が伸びる大分の工業港。サビキのアジ・サバが定番で、春から秋はエギングのアオリイカも人気。潮通しが良く、秋はイナダなど青物の回遊が期待できるのが魅力だ。足元の探り釣りではカサゴも拾える。JR津久見駅から徒歩約15分、津久見ICから約10分と電車・車どちらでも行きやすく、駐車場もある。防波堤は船の係留や荷役と隣り合わせなので、作業の妨げにならない釣り座選びを心がけたい。",
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 112,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 67,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "延岡新港は夜のルアーでシーバスが狙える港湾。五ヶ瀬川の河口近くに位置し、4〜11月がシーバスの最盛期。同時期は朝マヅメのサビキでアジ、4〜10月はフカセでクロダイ、5〜10月はチョイ投げでハゼも狙えます。港湾内に無料駐車スペースとトイレがあり、コンビニも近いので夜釣りの拠点にしやすい釣り場です。",
    ...
    isFree: true, hasParking: true, parkingDetail: "港湾内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 78, googleRating: 3.5, googleReviewCount: 8,
    catchableFish: [
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港湾内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.0, reviewCount: 96,
    catchableFish: [
  ...
  },
  {
    ...
    description: "志布志港は志布志湾の大型港で、アジやイワシ、青物が狙える。フェリーターミナルの防波堤からサビキでアジ・イワシが数釣れ、秋はイナダやブリのショアジギング、夜はタチウオ、春はマダイのカゴ釣りも実績。トイレ・駐車場・コンビニ完備。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 88, googleRating: 3.7, googleReviewCount: 16,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 3.7, reviewCount: 56, googleRating: 3.9, googleReviewCount: 371,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.2, reviewCount: 178, googleRating: 4.1, googleReviewCount: 1520,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 103, googleRating: 3.6, googleReviewCount: 82,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.1, reviewCount: 132,
    catchableFish: [
      { fish: fish("aoriika"), monthStart: 4, monthEnd: 6, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝夕マヅメ", method: "エギング", source: "エギCOM 呼子" },
      ...
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
          ...
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング", source: "エギCOM 呼子" },
          { fish: fish("madako"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "タコエギ" },
          { fish: fish("isaki"), monthStart: 5, monthEnd: 9, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "カゴ釣り" },
    ],
    bestTimes: btNight, tackleRecommendations: [],
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港付近に駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.4, reviewCount: 167,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.9, reviewCount: 121,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
  ...
  },
  {
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.8, reviewCount: 62, googleRating: 3.8, googleReviewCount: 93,
    catchableFish: [
  ...
  },
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.3, reviewCount: 72, googleRating: 3.5, googleReviewCount: 53,
    catchableFish: [
      { fish: fish("kanpachi"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 72, googleRating: 3.3, googleReviewCount: 4,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("suzuki"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  // ========================================
  {
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.3, reviewCount: 125,
    catchableFish: [
      { fish: fish("hiramasa"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング", source: "アングラーズ 壱岐島" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング", source: "エギCOM 壱岐" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り", source: "アングラーズ 壱岐島" },
          { fish: fish("madai"), monthStart: 3, monthEnd: 6, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "カゴ釣り" },
          { fish: fish("buri"), monthStart: 9, monthEnd: 2, peakSeason: false, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング", source: "カンパリ 壱岐島" },
          { fish: fish("sawara"), monthStart: 8, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "ショアジギング" },
          { fish: fish("mebaru"), monthStart: 11, monthEnd: 4, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ〜夜", method: "メバリング" },
          { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
          { fish: fish("madako"), monthStart: 6, monthEnd: 10, peakSeason: false, catchDifficulty: "medium", recommendedTime: "日中", method: "タコエギ" },
  ...
  // ========================================
  {
    ...
    description: "大分県杵築市、城下町の風情が残る守江湾の釣り場。7月〜11月はちょい投げのハゼ、10月〜4月は投げ釣りのカレイが看板で、サビキのアジ、メバル・カサゴの根魚、エギングのアオリイカ、タコエギのマダコまで狙える魚種が多彩。朝マヅメにはカゴ釣りのマダイ、ショアジギングでブリやサワラの回遊を待つ楽しみもある。漁港周辺に無料駐車場とトイレがあり、穏やかな内湾で足場も良く初心者やファミリーに最適。杵築ICから車で約10分で、城下町観光と合わせた釣行にも向く。",
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.6, reviewCount: 78, googleRating: 3, googleReviewCount: 1,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ釣り" },
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 4.1, reviewCount: 55, googleRating: 5, googleReviewCount: 1,
    catchableFish: [
      { fish: fish("kanpachi"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    mainImageUrl: "", images: [], rating: 4.4, reviewCount: 145, googleRating: 3.8, googleReviewCount: 79,
    catchableFish: [
  ...
  },
  {
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "", images: [], rating: 3.5, reviewCount: 52, googleRating: 4.3, googleReviewCount: 3,
    catchableFish: [
      { fish: fish("aji"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
