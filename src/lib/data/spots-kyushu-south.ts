...
export const kyushuSouthSpots: FishingSpot[] = [
  ...
  // ========================================
  {
    ...
    description: "大分県別府市の大型港湾。フェリーターミナルが隣接し、足場が良く初心者でも楽しめる。春〜秋はアジやサバのサビキ釣りが好調で、夜は太刀魚狙いのアングラーも多い。テンヤ釣りに加えて穴釣りも楽しめるため、一日中飽きません。タチウオ・カサゴ・マダイの好ポイントとしても地元で知られています。周辺には駐車場やトイレやコンビニがあり、釣り環境として不便がありません。",
    ...
    mainImageUrl: "/images/spots/wikimedia/beppu-kokusai-port.webp", imageAttribution: "Photo: Tabitan / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.8, reviewCount: 98, googleRating: 4.5, googleReviewCount: 40,
    catchableFish: [
  ...
  },
  {
    ...
    description: "大分県南部の主要港湾。リアス式海岸に囲まれた複雑な地形が良質な漁場を形成。クロダイやメジナなどの磯魚から、アジやイワシまで多彩な魚種が狙える釣りの名所。フカセ釣り・サビキ釣りと釣り方のバリエーションが豊富です。アオリイカなども回遊しており、シーズンを通して楽しめます。ある程度の経験を積んだ釣り人にとってやりがいのあるフィールドです。",
  ...
  },
  {
    ...
    description: "大分県津久見市の工業港。防波堤からのアジやサバのサビキ釣りが定番。春〜秋にはアオリイカのエギングも人気で、潮通しの良さから青物の回遊も期待できる。ショアジギングに加えてカゴ釣りも楽しめるため、一日中飽きません。イナダ・マダイ・ブリの好ポイントとしても地元で知られています。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。",
    ...
    mainImageUrl: "/images/spots/wikimedia/tsukumi-port.webp", imageAttribution: "Photo: Sharon Hahn Darlin / Wikimedia Commons (CC BY 4.0)", images: [], rating: 3.7, reviewCount: 62, googleRating: 4.2, googleReviewCount: 5,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "国宝の石仏で有名な臼杵市の港。穏やかな内湾の港でファミリーフィッシングに最適。アジやキスの数釣りが楽しめ、秋にはアオリイカの実績も高い釣り場。サビキ釣りに加えて投げ釣りも楽しめるため、一日中飽きません。シロギス・マダイ・ブリの好ポイントとしても地元で知られています。駐車場・トイレ・コンビニが整備されており、快適に釣行できます。",
  ...
  },
  {
    ...
    description: "豊後水道と瀬戸内海の合流点に位置する佐賀関港。潮通しが抜群で関サバ・関アジの漁場として名高い。堤防からのサビキ釣りでも良型のアジやサバが釣れる釣り師憧れの地。フカセ釣り・ショアジギングと釣り方のバリエーションが豊富です。クロダイやブリやマダイなども回遊しており、シーズンを通して楽しめます。経験者が通い込むだけの実力を秘めた釣り場です。",
    latitude: 33.25100, longitude: 131.86820,
    address: "〒879-2201 大分県大分市大字佐賀関750",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/saganoseki-port.webp", imageAttribution: "Photo: Yobito KAYANUMA / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.2, reviewCount: 134, googleRating: 3.8, googleReviewCount: 1070,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "宮崎県の中心的な港湾。防波堤やテトラ帯が充実しており、年間を通じてアジやイワシのサビキ釣りが楽しめる。夏〜秋は太刀魚の夜釣りが人気の釣り場。テンヤ釣りのほか、穴釣りでも好釣果が報告されています。時期によってはタチウオ・カサゴの釣果も期待できます。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
  ...
  },
  {
    ...
    description: "日南市の中心港湾。古くから漁業の街として栄え、港の防波堤からクロダイやメジナの磯釣りが楽しめる。カツオの一本釣りでも有名な港でもあり、周辺磯でのルアー釣りも盛ん。フカセ釣りやサビキ釣りといった釣り方で多くの釣り人が訪れます。アジやカンパチやマダイも狙えるため、ターゲットの幅が広いのが特徴です。中級者以上が腕を試すのに適した環境と魚影が魅力です。",
    latitude: 31.56900, longitude: 131.4015000,
    address: "〒887-0001 宮崎県日南市油津3丁目12",
    ...
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/aburatsu-port.webp", imageAttribution: "Photo: 松岡明芳 / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 4.0, reviewCount: 89, googleRating: 3.9, googleReviewCount: 7,
    catchableFish: [
  ...
  },
  {
    ...
    description: "宮崎県北部の主要港湾。工業港として整備されているが、周辺の波止からアジやカマスの数釣りが楽しめる。秋から冬はカマスの群れが回遊し、サビキやルアーで数釣りができる。サビキ釣りやサビキ釣り・ルアーなど複数の釣法に対応した好ポイントです。シーバスといった魚種の実績もあります。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。",
  ...
  },
  {
    ...
    description: "五ヶ瀬川の河口近くに位置する延岡市の港湾。シーバスの好ポイントとして有名で、河口部ではチヌやキビレも狙える。防波堤ではアジやイワシのサビキ釣りも人気。ルアーやフカセ釣りなど複数の釣法に対応した好ポイントです。クロダイ・ハゼ・マダイといった魚種の実績もあります。経験者が通い込むだけの実力を秘めた釣り場です。",
    latitude: 32.52270, longitude: 131.69260,
    address: "〒889-0511 宮崎県延岡市松原町3丁目",
    accessInfo: "JR延岡駅から車で約10分。延岡ICから約15分。",
    region: localRegion("r167"), spotType: "port", difficulty: "intermediate",
    isFree: true, hasParking: true, parkingDetail: "港湾内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/nobeoka-shinko.webp", imageAttribution: "Photo: ja:User:Sanjo / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.9, reviewCount: 78, googleRating: 3.5, googleReviewCount: 8,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "錦江湾奥に位置する鹿児島市の主要港湾。桜島を望む絶景の釣り場で、年間を通じてアジやイワシのサビキ釣りが楽しめる。夏は太刀魚、秋はカンパチの回遊もあり多彩な魚種が狙える。テンヤ釣り・ショアジギングと釣り方のバリエーションが豊富です。タチウオやシーバスやマダイなども回遊しており、シーズンを通して楽しめます。",
    latitude: 31.5950, longitude: 130.5760,
    address: "〒892-0835 鹿児島県鹿児島市城南町45－1",
    ...
    mainImageUrl: "/images/spots/wikimedia/kagoshima-shinko.webp", imageAttribution: "Photo: BirdsEyeLV / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.1, reviewCount: 145, googleRating: 3.8, googleReviewCount: 70,
    catchableFish: [
      { fish: fish("aji"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ釣り" },
  ...
  },
  {
    ...
    description: "カツオ漁業で有名な枕崎市の港湾。外洋に面した港で潮通しが良く、青物やシマアジなどの回遊魚が狙える本格的な釣り場。カツオのタタキが名物の街で釣りと食文化を同時に楽しめる。ショアジギングやフカセ釣りといった釣り方で多くの釣り人が訪れます。カンパチやshimaajiやクロダイも狙えるため、ターゲットの幅が広いのが特徴です。",
  ...
  },
  {
    ...
    description: "鹿児島県東部の志布志湾に位置する大型港湾。フェリーターミナルが整備された港で、防波堤からのアジやイワシ釣りが盛ん。秋にはカンパチやハマチの回遊もあり、ショアジギングも人気。サビキ釣りやテンヤ釣りなど複数の釣法に対応した好ポイントです。イナダ・タチウオ・マダイといった魚種の実績もあります。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    latitude: 31.47570, longitude: 131.107300,
    address: "〒899-7102 鹿児島県志布志市志布志町帖",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/shibushi-port.webp", imageAttribution: "Photo: 小倉ホ－ム / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.9, reviewCount: 88, googleRating: 3.7, googleReviewCount: 16,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("iwashi"), monthStart: 5, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "錦江湾を挟んで桜島の対岸に位置する垂水市のフェリー港。桜島を間近に望む絶景の中でアジやキスが狙える。フェリーの待ち時間を利用した釣りも楽しめるユニークなスポット。サビキ釣りや投げ釣りなど複数の釣法に対応した好ポイントです。シロギス・カサゴといった魚種の実績もあります。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
    ...
    mainImageUrl: "/images/spots/wikimedia/tarumizu-ferry-port.webp", imageAttribution: "Photo: Mizushimasea / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.7, reviewCount: 56, googleRating: 3.9, googleReviewCount: 371,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
  ...
  },
  {
    ...
    description: "活火山・桜島のフェリー乗り場周辺の釣りスポット。溶岩地帯が形成する複雑な海底地形に根魚が豊富。カサゴやメバルの穴釣りに加え、エギングでアオリイカも狙える特異な釣り場。アジング・メバリングやフカセ釣りなど複数の釣法に対応した好ポイントです。クロダイ・マダイ・ブリといった魚種の実績もあります。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/sakurajima-ferry-port.webp", imageAttribution: "Photo: 690 Noda / Wikimedia Commons (CC BY 3.0)", images: [], rating: 4.2, reviewCount: 178, googleRating: 4.1, googleReviewCount: 1520,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "佐賀県北部の玄界灘に面した唐津港。唐津城の麓に位置する風光明媚な港で、アジやサバのサビキ釣りが定番。外海に面した防波堤ではクロダイや青物も狙える。フカセ釣りのほか、ショアジギングでも好釣果が報告されています。時期によってはイナダの釣果も期待できます。手軽に楽しめる釣り場なので、家族のレジャーにもおすすめです。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/karatsu-port.webp", imageAttribution: "Photo: Muyo / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.9, reviewCount: 103, googleRating: 3.6, googleReviewCount: 82,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("saba"), monthStart: 7, monthEnd: 10, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "サビキ釣り" },
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
  ...
  },
  {
    ...
    description: "イカの活け造りで全国的に有名な呼子の港。ケンサキイカやスルメイカのイカ釣りが盛んで、港内では年間を通じてアジのサビキ釣りも楽しめる。観光と釣りを同時に楽しめる人気スポット。イカ釣り（浮き）のほか、エギングでも好釣果が報告されています。時期によってはsurumeika・kouika・クロダイの釣果も期待できます。",
  ...
  // ========================================
  {
    ...
    description: "歴史ある長崎市の港湾。女神大橋の下や長崎港周辺の防波堤ではアジやサバのサビキ釣りが楽しめる。春〜秋はメバルやカサゴの根魚釣りも人気で、市内からアクセスしやすい都市型釣り場。メバリングのほか、穴釣りでも好釣果が報告されています。時期によってはシーバス・マダイ・ブリの釣果も期待できます。釣り初心者でも比較的簡単に釣果を得られる条件が整っています。",
  ...
  },
  {
    ...
    description: "長崎県五島列島の中心・福江島の港湾。五島の海は透明度が高く、磯釣りの聖地として知られる。大型のクロダイやメジナ、アオリイカが狙え、本格的な磯釣りファンに人気の離島スポット。フカセ釣り・エギングと釣り方のバリエーションが豊富です。イシダイなども回遊しており、シーズンを通して楽しめます。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
  ...
  },
  {
    ...
    description: "歴史的な港町・平戸の港湾。平戸大橋のたもとから防波堤にかけてアジやクロダイが狙える。西洋との交流の歴史が残る風光明媚な港で、観光と釣りを楽しめる長崎県北部の人気スポット。サビキ釣りやフカセ釣りといった釣り方で多くの釣り人が訪れます。メバルやアオリイカやマダイも狙えるため、ターゲットの幅が広いのが特徴です。",
  ...
  },
  {
    ...
    description: "長崎県北部の主要港湾。佐世保湾に囲まれた穏やかな内湾で、ファミリーフィッシングに最適。アジやイワシのサビキ釣りから、湾内でのシーバス・クロダイまで幅広い釣りが楽しめる。ルアー・フカセ釣りと釣り方のバリエーションが豊富です。マダイやブリやサワラなども回遊しており、シーズンを通して楽しめます。駐車場・トイレ・コンビニが整備されており、快適に釣行できます。",
  ...
  // ========================================
  {
    ...
    description: "国東半島北端の漁港。周防灘と豊後水道が交わる好漁場で、アジやカマスが安定して釣れる。国東半島の仏教文化も見どころ。サビキ釣り・ルアーと釣り方のバリエーションが豊富です。アオリイカなども回遊しており、シーズンを通して楽しめます。ビギナーにもやさしいフィールドで、釣り入門にもおすすめの場所です。周辺には駐車場があり、釣り環境として不便がありません。",
    latitude: 33.6360, longitude: 131.6870,
    address: "〒872-1401 大分県国東市国見町伊美",
  ...
  },
  {
    ...
    description: "城下かれいで有名な日出町の漁港。別府湾に面した穏やかな港で、カレイやキスの投げ釣りが安定。ファミリー向け。ちょい投げやサビキ釣りといった釣り方で多くの釣り人が訪れます。シロギスやアジやマダイも狙えるため、ターゲットの幅が広いのが特徴です。駐車場やトイレやコンビニが近くにあるため長時間の釣りでも安心です。",
    latitude: 33.36970, longitude: 131.531200,
    address: "〒879-1505 大分県日出町川崎5969-41",
    accessInfo: "JR日豊本線日出駅から車で約10分。大分自動車道日出ICから約10分。",
    region: region("r33"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/hiji-toyooka-port.webp", imageAttribution: "Photo: Yasu (talk) / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 3.6, reviewCount: 78,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "鬼の洗濯板で有名な青島の漁港。宮崎市のリゾートエリアに位置し、堤防からアジやカマスが狙える。観光と釣りの両立が可能。サビキ釣りやルアーなど複数の釣法に対応した好ポイントです。カサゴ・マダイ・ブリといった魚種の実績もあります。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。駐車場やトイレやコンビニが近くにあるため長時間の釣りでも安心です。",
  ...
  },
  {
    ...
    description: "宮崎県南部の志布志湾沿岸。サーフからヒラメやキスが狙える広大な砂浜で、秋にはイナダの回遊も期待できる。ルアー・投げ釣りと釣り方のバリエーションが豊富です。シロギスなども回遊しており、シーズンを通して楽しめます。経験者が通い込むだけの実力を秘めた釣り場です。周辺には駐車場があり、釣り環境として不便がありません。",
    latitude: 31.5430, longitude: 131.1280,
    address: "〒888-0002 宮崎県串間市高松1481-3",
    ...
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/miyakonojo-shibushi-bay.webp", imageAttribution: "Photo: ja:User:Sanjo / Wikimedia Commons (Public domain)", images: [], rating: 3.8, reviewCount: 62, googleRating: 3.8, googleReviewCount: 93,
    catchableFish: [
  ...
  // ========================================
  {
    ...
    description: "砂むし温泉で有名な指宿市の港。薩摩半島南端に位置し、錦江湾の入口で魚種が豊富。アジやカンパチの回遊が期待できる。サビキ釣りに加えてショアジギングも楽しめるため、一日中飽きません。クロダイ・マダイ・ブリの好ポイントとしても地元で知られています。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
  ...
  },
  {
    ...
    description: "ロケット発射場で有名な種子島の中心港。離島ならではの魚影の濃さが魅力で、GT（ロウニンアジ）やカンパチなど南方系の大物が狙える。ショアジギングやサビキ釣りといった釣り方で多くの釣り人が訪れます。アオリイカやマダイやブリも狙えるため、ターゲットの幅が広いのが特徴です。経験者が通い込むだけの実力を秘めた釣り場です。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/tanegashima-nishinoomote-port.webp", imageAttribution: "Photo: くーさん from Japan / Wikimedia Commons (CC BY 2.0)", images: [], rating: 4.3, reviewCount: 72, googleRating: 3.5, googleReviewCount: 53,
    catchableFish: [
      { fish: fish("kanpachi"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
  ...
  // ========================================
  {
    ...
    description: "有明海に面した竹崎カニの産地。干満差が日本最大級の有明海で、干潮時に広がる干潟は独特の釣り環境。ハゼやチヌが狙える。ちょい投げ・フカセ釣りと釣り方のバリエーションが豊富です。クロダイやシーバスなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
  ...
  },
  {
    ...
    description: "伊万里焼で有名な伊万里市の港。伊万里湾の奥に位置する穏やかな港で、チヌやシーバスが狙える。陶芸の街の文化と釣りを同時に楽しめる。フカセ釣り・ルアーと釣り方のバリエーションが豊富です。クロダイやアジやマダイなども回遊しており、シーズンを通して楽しめます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。",
    ...
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/imari-port.webp", imageAttribution: "Photo: Peka / Wikimedia Commons (CC BY-SA 4.0)", images: [], rating: 3.6, reviewCount: 72, googleRating: 3.3, googleReviewCount: 4,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("seabass"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夜", method: "ルアー" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  // ========================================
  {
    ...
    description: "玄界灘に浮かぶ壱岐島の中心港。磯釣りの聖地として知られ、ヒラマサやクロダイの大物が狙える。日本遺産の島で釣りを楽しめる。ショアジギング・フカセ釣りと釣り方のバリエーションが豊富です。hiramasaやアオリイカやアジなども回遊しており、シーズンを通して楽しめます。経験者が通い込むだけの実力を秘めた釣り場です。",
    ...
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: true, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/iki-gonoura-port.webp", imageAttribution: "Photo: ChiefHira / Wikimedia Commons (CC BY-SA 3.0)", images: [], rating: 4.3, reviewCount: 125,
    catchableFish: [
  ...
  },
  {
    ...
    description: "日本最北西端の離島・対馬の中心港。韓国との国境に近い海域は魚種が豊富で、ヒラマサやクロダイの大物が期待できる究極の離島釣り。ショアジギングやフカセ釣りといった釣り方で多くの釣り人が訪れます。hiramasaやメジナやアオリイカも狙えるため、ターゲットの幅が広いのが特徴です。経験者が通い込むだけの実力を秘めた釣り場です。",
  ...
  // ========================================
  {
    ...
    description: "城下町の風情が残る杵築市の守江湾。穏やかな内湾でハゼやカレイが安定して釣れ、初心者やファミリーに最適な釣り場。ちょい投げに加えて投げ釣りも楽しめるため、一日中飽きません。アジ・マダイ・ブリの好ポイントとしても地元で知られています。周辺には駐車場やトイレがあり、釣り環境として不便がありません。釣り場への入場は無料で、コストを抑えた釣行が可能です。",
    latitude: 33.4210, longitude: 131.6180,
    address: "〒873-0033 大分県杵築市守江4785",
    accessInfo: "JR日豊本線杵築駅から車で約15分。大分空港道路杵築ICから約10分。",
    region: region("r33"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "漁港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kitsuki-morie-bay.webp", imageAttribution: "Photo: shikabane taro / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.5, reviewCount: 58,
    catchableFish: [
      { fish: fish("haze"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
      { fish: fish("karei"), monthStart: 10, monthEnd: 4, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
  ...
  },
  {
    ...
    description: "宮崎県中部の高鍋町の漁港。太平洋に面した港でアジやタチウオが安定して釣れる。宮崎を代表する餃子の街で食も楽しめる。サビキ釣りやテンヤ釣りなど複数の釣法に対応した好ポイントです。シロギス・マダイ・ブリといった魚種の実績もあります。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。駐車場やトイレやコンビニが近くにあるため長時間の釣りでも安心です。",
    latitude: 32.11770, longitude: 131.53640,
    address: "〒884-0004 宮崎県高鍋町",
    accessInfo: "JR日豊本線高鍋駅から車で約10分。東九州自動車道高鍋ICから約10分。",
    region: localRegion("r164"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/takanabe-port.webp", imageAttribution: "Photo: 特急東海 / Wikimedia Commons (CC0)", images: [], rating: 3.6, reviewCount: 78, googleRating: 3, googleReviewCount: 1,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ釣り" },
  ...
  },
  {
    ...
    description: "薩摩半島西岸の笠沙は杜氏の里として知られる。東シナ海に面した好漁場で、カンパチやヒラマサなどの青物が狙える本格スポット。ショアジギングやサビキ釣りといった釣り方で多くの釣り人が訪れます。アジやアオリイカも狙えるため、ターゲットの幅が広いのが特徴です。経験者が通い込むだけの実力を秘めた釣り場です。周辺には駐車場があり、釣り環境として不便がありません。",
    latitude: 31.4050, longitude: 130.2310,
    address: "〒897-1301 鹿児島県南さつま市笠沙町片浦439-2",
    accessInfo: "鹿児島市内から車で約2時間。南さつま市街から約30分。",
    region: localRegion("r169"), spotType: "port", difficulty: "intermediate",
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/minami-satsuma-kasasa-port.jpg", images: [], rating: 4.1, reviewCount: 55, googleRating: 5, googleReviewCount: 1,
    catchableFish: [
      { fish: fish("kanpachi"), monthStart: 6, monthEnd: 10, peakSeason: true, catchDifficulty: "hard", recommendedTime: "朝マヅメ", method: "ショアジギング" },
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "天草諸島の中心港。天草四郎の歴史が残る島で、アジやクロダイが安定して釣れる。イルカウォッチングも楽しめる。サビキ釣りのほか、フカセ釣りでも好釣果が報告されています。時期によってはアオリイカ・マダイ・ブリの釣果も期待できます。初心者や家族連れでも安心して釣りを楽しめる環境が揃っています。駐車場とトイレとコンビニが利用可能で、実用面でも優れた釣り場です。",
  ...
  },
  {
    ...
    description: "雲仙普賢岳を望む島原の外港。有明海に面した港で、チヌやシーバスが狙える。島原温泉と組み合わせた釣り旅に最適。フカセ釣り・ルアーと釣り方のバリエーションが豊富です。クロダイやアジなども回遊しており、シーズンを通して楽しめます。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。駐車場・トイレ・コンビニが整備されており、快適に釣行できます。",
  ...
  },
  {
    ...
    description: "奄美群島の中心・奄美大島の名瀬港。亜熱帯の海に囲まれ、GT（ロウニンアジ）やカンパチなど南方系の大物が狙える離島の聖地。ショアジギングやルアーといった釣り方で多くの釣り人が訪れます。hataやアオリイカやマダイも狙えるため、ターゲットの幅が広いのが特徴です。釣り慣れた方であればテクニック次第で良型が期待できるポイントです。",
    latitude: 28.3770, longitude: 129.4980,
    address: "〒894-0000 鹿児島県奄美市名瀬永田町17-3",
    ...
    mainImageUrl: "/images/spots/wikimedia/amami-naze-port.webp", imageAttribution: "Photo: tsuda from Tsushima, Aichi, Japan / Wikimedia Commons (CC BY-SA 2.0)", images: [], rating: 4.4, reviewCount: 145, googleRating: 3.8, googleReviewCount: 79,
    catchableFish: [
  ...
  },
  {
    ...
    description: "大隅半島の鹿屋市にある古江港。錦江湾東岸で桜島を望む絶景の釣り場。アジやキスが安定して釣れるファミリー向けスポット。サビキ釣りや投げ釣りといった釣り方で多くの釣り人が訪れます。シロギスやカサゴやマダイも狙えるため、ターゲットの幅が広いのが特徴です。駐車場が利用可能で、実用面でも優れた釣り場です。釣り場への入場は無料で、コストを抑えた釣行が可能です。",
    latitude: 31.3490, longitude: 130.7260,
    address: "〒891-2321 鹿児島県鹿屋市古江町7440-3",
    accessInfo: "鹿屋市内から車で約15分。大隅縦貫道鹿屋串良ICから約20分。",
    region: localRegion("r171"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/kanoya-furue-port.jpg", images: [], rating: 3.5, reviewCount: 52, googleRating: 4.3, googleReviewCount: 3,
    catchableFish: [
      { fish: fish("aji"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "投げ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
  ...
  },
  {
    ...
    description: "宮崎市南部の太平洋に面した漁港。南国の温暖な気候で年間を通じて釣りが楽しめ、アジやカマスの数釣りが人気。サビキ釣り・ルアーと釣り方のバリエーションが豊富です。アオリイカなども回遊しており、シーズンを通して楽しめます。初めて竿を出す方にも向いており、子供連れでの釣行にも適しています。駐車場が近くにあるため長時間の釣りでも安心です。",
    ...
    isFree: true, hasParking: true, parkingDetail: "漁港内に無料駐車スペースあり",
    hasToilet: false, hasConvenienceStore: false, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/miyazaki-uchinomi-port.webp", imageAttribution: "Photo: xpoxoqx / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 65, googleRating: 3.9, googleReviewCount: 20,
    catchableFish: [
      { fish: fish("aji"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("kamasu"), monthStart: 9, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "朝マヅメ", method: "ルアー" },
      { fish: fish("aoriika"), monthStart: 9, monthEnd: 12, peakSeason: false, catchDifficulty: "medium", recommendedTime: "夕マヅメ", method: "エギング" },
  ...
  },
  {
    ...
    description: "長崎県中部の大村湾に面した漁港。波が穏やかな内海で、チヌやキスが安定して釣れるファミリー向けスポット。長崎空港に近い。フカセ釣りやちょい投げなど複数の釣法に対応した好ポイントです。クロダイ・シロギス・ハゼといった魚種の実績もあります。駐車場とコンビニが利用可能で、実用面でも優れた釣り場です。釣り場への入場は無料で、コストを抑えた釣行が可能です。",
    latitude: 32.9160, longitude: 129.9480,
    address: "〒856-0008 長崎県大村市松原2丁目 鹿ノ島漁港",
    ...
    mainImageUrl: "/images/spots/wikimedia/omura-kuromaru-port.webp", imageAttribution: "Photo: kajikawa / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.5, reviewCount: 62,
    catchableFish: [
      { fish: fish("kurodai"), monthStart: 4, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "朝マヅメ", method: "フカセ釣り" },
      { fish: fish("kisu"), monthStart: 5, monthEnd: 9, peakSeason: true, catchDifficulty: "easy", recommendedTime: "日中", method: "ちょい投げ" },
  ...
  },
  {
    ...
    description: "霧島温泉郷に近い錦江湾沿いの港。桜島を正面に望む絶景の釣り場で、アジやタチウオが安定して釣れる。温泉旅行の合間に。サビキ釣りのほか、テンヤ釣りでも好釣果が報告されています。時期によってはカサゴ・マダイ・ブリの釣果も期待できます。エントリーしやすい釣り場で、初心者が最初の一匹を手にするのにぴったりです。",
    latitude: 31.71830, longitude: 130.72770,
    address: "〒899-5102 鹿児島県霧島市隼人町真孝",
    accessInfo: "JR日豊本線隼人駅から車で約10分。東九州自動車道隼人東ICから約5分。",
    region: localRegion("r168"), spotType: "port", difficulty: "beginner",
    isFree: true, hasParking: true, parkingDetail: "港周辺に無料駐車場あり",
    hasToilet: true, hasConvenienceStore: true, hasFishingShop: false, hasRentalRod: false,
    mainImageUrl: "/images/spots/wikimedia/kirishima-hayato-port.webp", imageAttribution: "Photo: Kashiwagi Akihiro *ja:柏木 明博 / Wikimedia Commons (CC BY 3.0)", images: [], rating: 3.6, reviewCount: 72, googleRating: 3.1, googleReviewCount: 7,
    catchableFish: [
      { fish: fish("aji"), monthStart: 3, monthEnd: 12, peakSeason: true, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "サビキ釣り" },
      { fish: fish("tachiuo"), monthStart: 7, monthEnd: 11, peakSeason: true, catchDifficulty: "medium", recommendedTime: "夜", method: "テンヤ釣り" },
      { fish: fish("kasago"), monthStart: 10, monthEnd: 4, peakSeason: false, catchDifficulty: "easy", recommendedTime: "夕マヅメ", method: "穴釣り" },
